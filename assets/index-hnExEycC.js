...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Sn,depthTest:!1,depthWrite:!1})}function d0(i,e,t){const n=new Float32Array(Bi),s=new D(0,1,0);return new Ct({name:"SphericalGaussianBlur",defines:{n:Bi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:ba(),fragmentShader:`
		...
		`,blending:Sn,depthTest:!1,depthWrite:!1})}function du(){return new Ct({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ba(),fragmentShader:`
		...
		`,blending:Sn,depthTest:!1,depthWrite:!1})}function fu(){return new Ct({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ba(),fragmentShader:`
	...
	`}class Eh extends Ot{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new hh(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new ws(5,5,5),r=new Ct({name:"CubemapFromEquirect",uniforms:Es(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:$t,blending:Sn});r.uniforms.tEquirect.value=t;const a=new ut(s,r),o=t.minFilter;return t.minFilter===ni&&(t.minFilter=Mt),new rp(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,s);e.setRenderTarget(r)}}function f0(i){let e=new WeakMap,t=new WeakMap,n=null;function s(h,f=!1){return h==null?null:f?a(h):r(h)}function r(h){if(h&&h.isTexture){const f=h.mapping;if(f===La||f===Ia)if(e.has(h)){const g=e.get(h).texture;return o(g,h.mapping)}else{const g=h.image;if(g&&g.height>0){const x=new Eh(g.height);return x.fromEquirectangularTexture(i,h),e.set(h,x),h.addEventListener("dispose",c),o(x.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){const f=h.mapping,g=f===La||f===Ia,x=f===zi||f===ys;if(g||x){let m=t.get(h);const p=m!==void 0?m.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==p)return n===null&&(n=new ul(i)),m=g?n.fromEquirectangular(h,m):n.fromCubemap(h,m),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),m.texture;if(m!==void 0)return m.texture;{const y=h.image;return g&&y&&y.height>0||x&&y&&l(y)?(n===null&&(n=new ul(i)),m=g?n.fromEquirectangular(h):n.fromCubemap(h),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),h.addEventListener("dispose",u),m.texture):null}}}return h}function o(h,f){return f===La?h.mapping=zi:f===Ia&&(h.mapping=ys),h}function l(h){let f=0;const g=6;for(let x=0;x<g;x++)h[x]!==void 0&&f++;return f===g}function c(h){const f=h.target;f.removeEventListener("dispose",c);const g=e.get(f);g!==void 0&&(e.delete(f),g.dispose())}function u(h){const f=h.target;f.removeEventListener("dispose",u);const g=t.get(f);g!==void 0&&(t.delete(f),g.dispose())}function d(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:d}}function p0(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&vs("WebGLRenderer: "+n+" extension not supported."),s}}}function m0(i,e,t,n){const s={},r=new WeakMap;function a(d){const h=d.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);h.removeEventListener("dispose",a),delete s[h.id];const f=r.get(h);f&&(e.remove(f),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(d,h){return s[h.id]===!0||(h.addEventListener("dispose",a),s[h.id]=!0,t.memory.geometries++),h}function l(d){const h=d.attributes;for(const f in h)e.update(h[f],i.ARRAY_BUFFER)}function c(d){const h=[],f=d.index,g=d.attributes.position;let x=0;if(g===void 0)return;if(f!==null){const y=f.array;x=f.version;for(let w=0,S=y.length;w<S;w+=3){const T=y[w+0],E=y[w+1],C=y[w+2];h.push(T,E,E,C,C,T)}}else{const y=g.array;x=g.version;for(let w=0,S=y.length/3-1;w<S;w+=3){const T=w+0,E=w+1,C=w+2;h.push(T,E,E,C,C,T)}}const m=new(g.count>=65535?ah:rh)(h,1);m.version=x;const p=r.get(d);p&&e.remove(p),r.set(d,m)}function u(d){const h=r.get(d);if(h){const f=d.index;f!==null&&h.version<f.version&&c(d)}else c(d);return r.get(d)}return{get:o,update:l,getWireframeAttribute:u}}function g0(i,e,t){let n;function s(d){n=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function l(d,h){i.drawElements(n,h,r,d*a),t.update(h,n,1)}function c(d,h,f){f!==0&&(i.drawElementsInstanced(n,h,r,d*a,f),t.update(h,n,f))}function u(d,h,f){if(f===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,r,d,0,f);let x=0;for(let m=0;m<f;m++)x+=h[m];t.update(x,n,1)}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u}function _0(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:De("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function v0(i,e,t){const n=new WeakMap,s=new it;function r(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,d=u!==void 0?u.length:0;let h=n.get(o);if(h===void 0||h.count!==d){let L=function(){v.dispose(),n.delete(o),o.removeEventListener("dispose",L)};var f=L;h!==void 0&&h.texture.dispose();const g=o.morphAttributes.position!==void 0,x=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],y=o.morphAttributes.normal||[],w=o.morphAttributes.color||[];let S=0;g===!0&&(S=1),x===!0&&(S=2),m===!0&&(S=3);let T=o.attributes.position.count*S,E=1;T>e.maxTextureSize&&(E=Math.ceil(T/e.maxTextureSize),T=e.maxTextureSize);const C=new Float32Array(T*E*4*d),v=new th(C,T,E,d);v.type=fn,v.needsUpdate=!0;const A=S*4;for(let R=0;R<d;R++){const F=p[R],X=y[R],j=w[R],O=T*E*4*R;for(let Y=0;Y<F.count;Y++){const V=Y*A;g===!0&&(s.fromBufferAttribute(F,Y),C[O+V+0]=s.x,C[O+V+1]=s.y,C[O+V+2]=s.z,C[O+V+3]=0),x===!0&&(s.fromBufferAttribute(X,Y),C[O+V+4]=s.x,C[O+V+5]=s.y,C[O+V+6]=s.z,C[O+V+7]=0),m===!0&&(s.fromBufferAttribute(j,Y),C[O+V+8]=s.x,C[O+V+9]=s.y,C[O+V+10]=s.z,C[O+V+11]=j.itemSize===4?s.w:1)}}h={count:d,texture:v,size:new ge(T,E)},n.set(o,h),o.addEventListener("dispose",L)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const x=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",x),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:r}}function x0(i,e,t,n,s){let r=new WeakMap;function a(c){const u=s.render.frame,d=c.geometry,h=e.get(c,d);if(r.get(h)!==u&&(e.update(h),r.set(h,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==u&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,u))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==u&&(f.update(),r.set(f,u))}return h}function o(){r=new WeakMap}function l(c){const u=c.target;u.removeEventListener("dispose",l),n.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:a,dispose:o}}const M0={[yl]:"LINEAR_TONE_MAPPING",[bl]:"REINHARD_TONE_MAPPING",[El]:"CINEON_TONE_MAPPING",[Ma]:"ACES_FILMIC_TONE_MAPPING",[Al]:"AGX_TONE_MAPPING",[wl]:"NEUTRAL_TONE_MAPPING",[Tl]:"CUSTOM_TONE_MAPPING"};function S0(i,e,t,n,s,r){const a=new Ot(e,t,{type:i,depthBuffer:s,stencilBuffer:r,samples:n?4:0,depthTexture:s?new Hi(e,t):void 0}),o=new Ot(e,t,{type:Gt,depthBuffer:!1,stencilBuffer:!1}),l=new en;l.setAttribute("position",new Jt([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute("uv",new Jt([0,2,0,0,2,0],2));const c=new ph({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new ut(l,c),d=new pr(-1,1,1,-1,0,1);let h=null,f=null,g=!1,x,m=null,p=[],y=!1;this.setSize=function(w,S){a.setSize(w,S),o.setSize(w,S);for(let T=0;T<p.length;T++){const E=p[T];E.setSize&&E.setSize(w,S)}},this.setEffects=function(w){p=w,y=p.length>0&&p[0].isRenderPass===!0;const S=a.width,T=a.height;for(let E=0;E<p.length;E++){const C=p[E];C.setSize&&C.setSize(S,T)}},this.begin=function(w,S){if(g||w.toneMapping===Gn&&p.length===0)return!1;if(m=S,S!==null){const T=S.width,E=S.height;(a.width!==T||a.height!==E)&&this.setSize(T,E)}return y===!1&&w.setRenderTarget(a),x=w.toneMapping,w.toneMapping=Gn,!0},this.hasRenderPass=function(){return y},this.end=function(w,S){w.toneMapping=x,g=!0;let T=a,E=o;for(let C=0;C<p.length;C++){const v=p[C];if(v.enabled!==!1&&(v.render(w,E,T,S),v.needsSwap!==!1)){const A=T;T=E,E=A}}if(h!==w.outputColorSpace||f!==w.toneMapping){h=w.outputColorSpace,f=w.toneMapping,c.defines={},He.getTransfer(h)===Je&&(c.defines.SRGB_TRANSFER="");const C=M0[f];C&&(c.defines[C]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=T.texture,w.setRenderTarget(m),w.render(u,d),m=null,g=!1},this.isCompositing=function(){return g},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),l.dispose(),c.dispose()}}const Th=new Ft,hl=new Hi(1,1),Ah=new th,wh=new cf,Ch=new hh,pu=[],mu=[],gu=new Float32Array(16),_u=new Float32Array(9),vu=new Float32Array(4);function Is(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=pu[s];if(r===void 0&&(r=new Float32Array(s),pu[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function Rt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Pt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Ea(i,e){let t=mu[e];t===void 0&&(t=new Int32Array(e),mu[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function y0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function b0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Rt(t,e))return;i.uniform2fv(this.addr,e),Pt(t,e)}}function E0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Rt(t,e))return;i.uniform3fv(this.addr,e),Pt(t,e)}}function T0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Rt(t,e))return;i.uniform4fv(this.addr,e),Pt(t,e)}}function A0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Rt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Pt(t,e)}else{if(Rt(t,n))return;vu.set(n),i.uniformMatrix2fv(this.addr,!1,vu),Pt(t,n)}}function w0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Rt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Pt(t,e)}else{if(Rt(t,n))return;_u.set(n),i.uniformMatrix3fv(this.addr,!1,_u),Pt(t,n)}}function C0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Rt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Pt(t,e)}else{if(Rt(t,n))return;gu.set(n),i.uniformMatrix4fv(this.addr,!1,gu),Pt(t,n)}}function R0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function P0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Rt(t,e))return;i.uniform2iv(this.addr,e),Pt(t,e)}}function D0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Rt(t,e))return;i.uniform3iv(this.addr,e),Pt(t,e)}}function L0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Rt(t,e))return;i.uniform4iv(this.addr,e),Pt(t,e)}}function I0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function N0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Rt(t,e))return;i.uniform2uiv(this.addr,e),Pt(t,e)}}function U0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Rt(t,e))return;i.uniform3uiv(this.addr,e),Pt(t,e)}}function F0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Rt(t,e))return;i.uniform4uiv(this.addr,e),Pt(t,e)}}function O0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(hl.compareFunction=t.isReversedDepthBuffer()?Fl:Ul,r=hl):r=Th,t.setTexture2D(e||r,s)}function B0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||wh,s)}function k0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Ch,s)}function z0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Ah,s)}function V0(i){switch(i){case 5126:return y0;case 35664:return b0;case 35665:return E0;case 35666:return T0;case 35674:return A0;case 35675:return w0;case 35676:return C0;case 5124:case 35670:return R0;case 35667:case 35671:return P0;case 35668:case 35672:return D0;case 35669:case 35673:return L0;case 5125:return I0;case 36294:return N0;case 36295:return U0;case 36296:return F0;case 35678:case 36198:case 36298:case 36306:case 35682:return O0;case 35679:case 36299:case 36307:return B0;case 35680:case 36300:case 36308:case 36293:return k0;case 36289:case 36303:case 36311:case 36292:return z0}}function H0(i,e){i.uniform1fv(this.addr,e)}function G0(i,e){const t=Is(e,this.size,2);i.uniform2fv(this.addr,t)}function W0(i,e){const t=Is(e,this.size,3);i.uniform3fv(this.addr,t)}function X0(i,e){const t=Is(e,this.size,4);i.uniform4fv(this.addr,t)}function Y0(i,e){const t=Is(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function q0(i,e){const t=Is(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function K0(i,e){const t=Is(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function $0(i,e){i.uniform1iv(this.addr,e)}function Z0(i,e){i.uniform2iv(this.addr,e)}function J0(i,e){i.uniform3iv(this.addr,e)}function j0(i,e){i.uniform4iv(this.addr,e)}function Q0(i,e){i.uniform1uiv(this.addr,e)}function e_(i,e){i.uniform2uiv(this.addr,e)}function t_(i,e){i.uniform3uiv(this.addr,e)}function n_(i,e){i.uniform4uiv(this.addr,e)}function i_(i,e,t){const n=this.cache,s=e.length,r=Ea(t,s);Rt(n,r)||(i.uniform1iv(this.addr,r),Pt(n,r));let a;this.type===i.SAMPLER_2D_SHADOW?a=hl:a=Th;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function s_(i,e,t){const n=this.cache,s=e.length,r=Ea(t,s);Rt(n,r)||(i.uniform1iv(this.addr,r),Pt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||wh,r[a])}function r_(i,e,t){const n=this.cache,s=e.length,r=Ea(t,s);Rt(n,r)||(i.uniform1iv(this.addr,r),Pt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Ch,r[a])}function a_(i,e,t){const n=this.cache,s=e.length,r=Ea(t,s);Rt(n,r)||(i.uniform1iv(this.addr,r),Pt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Ah,r[a])}function o_(i){switch(i){case 5126:return H0;case 35664:return G0;case 35665:return W0;case 35666:return X0;case 35674:return Y0;case 35675:return q0;case 35676:return K0;case 5124:case 35670:return $0;case 35667:case 35671:return Z0;case 35668:case 35672:return J0;case 35669:case 35673:return j0;case 5125:return Q0;case 36294:return e_;case 36295:return t_;case 36296:return n_;case 35678:case 36198:case 36298:case 36306:case 35682:return i_;case 35679:case 36299:case 36307:return s_;case 35680:case 36300:case 36308:case 36293:return r_;case 36289:case 36303:case 36311:case 36292:return a_}}class l_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=V0(t.type)}}class c_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=o_(t.type)}}class u_{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const fo=/(\w+)(\])?(\[|\.)?/g;function xu(i,e){i.seq.push(e),i.map[e.id]=e}function h_(i,e,t){const n=i.name,s=n.length;for(fo.lastIndex=0;;){const r=fo.exec(n),a=fo.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){xu(t,c===void 0?new l_(o,i,e):new c_(o,i,e));break}else{let d=t.map[o];d===void 0&&(d=new u_(o),xu(t,d)),t=d}}}class oa{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);h_(o,l,this)}const s=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function Mu(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const d_=37297;let f_=0;function p_(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Su=new Ie;function m_(i){He._getMatrix(Su,He.workingColorSpace,i);const e=`mat3( ${Su.elements.map(t=>t.toFixed(4))} )`;switch(He.getTransfer(i)){case fa:return[e,"LinearTransferOETF"];case Je:return[e,"sRGBTransferOETF"];default:return be("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function yu(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+p_(i.getShaderSource(e),o)}else return r}function g_(i,e){const t=m_(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const __={[yl]:"Linear",[bl]:"Reinhard",[El]:"Cineon",[Ma]:"ACESFilmic",[Al]:"AgX",[wl]:"Neutral",[Tl]:"Custom"};function v_(i,e){const t=__[e];return t===void 0?(be("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Jr=new D;function x_(){He.getLuminanceCoefficients(Jr);const i=Jr.x.toFixed(4),e=Jr.y.toFixed(4),t=Jr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function y_(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Qs(i){return i!==""}function bu(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Eu(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const b_=/^[ \t]*#include +<([\w\d./]+)>/gm;function dl(i){return i.replace(b_,T_)}const E_=new Map;function T_(i,e){let t=ke[e];if(t===void 0){const n=E_.get(e);if(n!==void 0)t=ke[n],be('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return dl(t)}const A_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Tu(i){return i.replace(A_,w_)}function w_(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Au(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const C_={[ta]:"SHADOWMAP_TYPE_PCF",[Js]:"SHADOWMAP_TYPE_VSM"};function R_(i){return C_[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const P_={[zi]:"ENVMAP_TYPE_CUBE",[ys]:"ENVMAP_TYPE_CUBE",[Sa]:"ENVMAP_TYPE_CUBE_UV"};function D_(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":P_[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const L_={[ys]:"ENVMAP_MODE_REFRACTION"};function I_(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":L_[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const N_={[Sl]:"ENVMAP_BLENDING_MULTIPLY",[yd]:"ENVMAP_BLENDING_MIX",[bd]:"ENVMAP_BLENDING_ADD"};function U_(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":N_[i.combine]||"ENVMAP_BLENDING_NONE"}function F_(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function O_(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=R_(t),c=D_(t),u=I_(t),d=U_(t),h=F_(t),f=M_(t),g=S_(r),x=s.createProgram();let m,p,y=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const w=y+m+a,S=y+p+o,T=Mu(s,s.VERTEX_SHADER,w),E=Mu(s,s.FRAGMENT_SHADER,S);s.attachShader(x,T),s.attachShader(x,E),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function C(R){if(i.debug.checkShaderErrors){const F=s.getProgramInfoLog(x)||"",X=s.getShaderInfoLog(T)||"",j=s.getShaderInfoLog(E)||"",O=F.trim(),Y=X.trim(),V=j.trim();let J=!0,ee=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(J=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,T,E);else{const he=yu(s,T,"vertex"),me=yu(s,E,"fragment");De("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	...
	value:`,a)}addColor(e,t,n=1){return new Ov(this,e,t,n)}addFolder(e){const t=new Zl({parent:this,title:e});return this.root._closeFolders&&t.close(),t}load(e,t=!0){return e.controllers&&this.controllers.forEach(n=>{n instanceof go||n._name in e.controllers&&n.load(e.controllers[n._name])}),t&&e.folders&&this.folders.forEach(n=>{n._title in e.folders&&n.load(e.folders[n._title])}),this}save(e=!0){const t={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof go)){if(n._name in t.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);t.controllers[n._name]=n.save()}}),e&&this.folders.forEach(n=>{if(n._title in t.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);t.folders[n._title]=n.save()}),t}open(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(e){this._closed!==e&&(this._closed=e,this._callOnOpenClose(this))}show(e=!0){return this._hidden=!e,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const t=this.$children.clientHeight;this.$children.style.height=t+"px",this.domElement.classList.add("transition");const n=r=>{r.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const s=e?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!e),requestAnimationFrame(()=>{this.$children.style.height=s+"px"})}),this}title(e){return this._title=e,this.$title.textContent=e,this}reset(e=!0){return(e?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(e){return this._onChange=e,this}_callOnChange(e){this.parent&&this.parent._callOnChange(e),this._onChange!==void 0&&this._onChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onFinishChange(e){return this._onFinishChange=e,this}_callOnFinishChange(e){this.parent&&this.parent._callOnFinishChange(e),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onOpenClose(e){return this._onOpenClose=e,this}_callOnOpenClose(e){this.parent&&this.parent._callOnOpenClose(e),this._onOpenClose!==void 0&&this._onOpenClose.call(this,e)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(e=>e.destroy())}controllersRecursive(){let e=Array.from(this.controllers);return this.folders.forEach(t=>{e=e.concat(t.controllersRecursive())}),e}foldersRecursive(){let e=Array.from(this.folders);return this.folders.forEach(t=>{e=e.concat(t.foldersRecursive())}),e}}const Gv={appTitle:"🪨 토양 스튜디오 (한글판)",creditBrand:"토양 스튜디오",creditHint:"드래그로 궤도 회전 · 스크롤로 줌 · 지면 조각하기",guiTitle:"🪨 토양 스튜디오",folderMaterial:"머티리얼",folderSoil:"토양 표면",folderMounds:"언덕과 기복",folderTone:"톤과 색상",folderMoisture:"수분",folderCracks:"마른 균열",folderMoss:"🌿 이끼",folderMossMask:"범위 마스크",folderMossVol:"높이 볼륨",folderMossLook:"텍스처와 셰이딩",folderModel:"🚗 모델",folderAccum:"이끼 누적",folderGrass:"🌱 잔디",folderGrassMask:"범위 마스크",folderWind:"🍃 바람",folderLighting:"조명",folderClouds:"☁️ 구름",folderCShape:"모양",folderCMove:"움직임",folderCLight:"조명과 색상",folderCQuality:"품질",folderCine:"🎬 시네마틱",folderCam:"카메라",folderDof:"피사계 심도",folderFx:"효과",materialBase:"베이스 셋",materialMix:"믹스",normalStrength:"노멀 강도",displacement:"변위",randomizeSeed:"🎲 시드 무작위화",moundScale:"언덕 스케일",reliefScale:"기복 스케일",reliefStrength:"기복 강도",toneColor:"톤 색상",toneCoverage:"톤 범위",toneScale:"톤 스케일",moistureLevel:"수분 레벨",moistureCoverage:"수분 범위",moistureScale:"수분 스케일",moistureEdge:"수분 가장자리",moistureDarken:"수분 어둡게",moistureGloss:"수분 광택",crackStrength:"균열 강도",crackScale:"균열 스케일",crackEdge:"균열 가장자리",crackDepth:"균열 깊이",mossEnabled:"이끼 켜기",mossHeight:"이끼 높이",mossCoverage:"범위",mossMaskScale:"마스크 스케일",mossEdge:"가장자리",mossPatchy:"얼룩 정도",mossHeightVar:"높이 변화",mossRoughness:"거칠기",mossBump:"범프",mossBumpScale:"범프 스케일",mossSpore:"포자 / 반짝임",modelPick:"모델 선택",modelLoad:"Load .glb…",modelMoss:"이끼 누적",accumCoverage:"범위",accumScale:"스케일",accumEdge:"가장자리",accumHeightVar:"높이 변화",accumSeedX:"시드 X",accumSeedY:"시드 Y",accumRandomize:"🎲 시드 무작위화",grassEnabled:"잔디 켜기",grassCount:"잔디 수",grassCoverage:"범위",grassMaskScale:"마스크 스케일",grassEdge:"가장자리",grassHeight:"잔디 키",grassWidth:"잔디 너비",grassTint:"잔디 틴트",grassPatchy:"얼룩 정도",windStrength:"바람 강도",windSpeed:"바람 속도",windGust:"gust 크기",windDir:"바람 방향",windFlutter:"flutter",exposure:"노출",keyLight:"키 라이트",fillLight:"필 라이트",rimLight:"림 라이트",ambient:"환경광",envIntensity:"환경 / IBL",cloudsEnabled:"구름 켜기",cloudCoverage:"범위",cloudDensity:"밀도",cloudAltitude:"고도",cloudThickness:"두께",cloudScale:"스케일",cloudRoundness:"둥글기",cloudWisp:"실키함",cloudSpeed:"속도",cloudSun:"태양 강도",cloudAmbient:"환경",cloudSteps:"단계",cloudDownres:"저해상도",autoOrbit:"자동 회전",orbitSpeed:"회전 속도",fov:"초점 / FOV",letterbox:"레터박스",dofEnabled:"피사계 심도 켜기",focusDistance:"초점 거리",aperture:"조리개",maxBlur:"최대 블러",bloom:"블룸",bloomRadius:"블룸 반경",bloomThreshold:"블룸 임계값",filmGrain:"필름 그레인",vignette:"비네트",chromaticAberration:"색수차",contrast:"대비",saturation:"채도"},Wv={appTitle:"🪨 Soil Studio",creditBrand:"SOIL STUDIO",creditHint:"drag to orbit · scroll to zoom · sculpt the ground",guiTitle:"🪨 Soil Studio",folderMaterial:"Material",folderSoil:"Soil Surface",folderMounds:"Mounds & Relief",folderTone:"Tone & Color",folderMoisture:"Moisture",folderCracks:"Dry Cracks",folderMoss:"🌿 Moss Cover",folderMossMask:"Coverage Mask",folderMossVol:"Height Volume",folderMossLook:"Texture & Shading",folderModel:"🚗 Model",folderAccum:"Moss Accumulation",folderGrass:"🌱 Grass",folderGrassMask:"Coverage Mask",folderWind:"🍃 Wind",folderLighting:"Lighting",folderClouds:"☁️ Clouds",folderCShape:"Shape",folderCMove:"Motion",folderCLight:"Lighting & Color",folderCQuality:"Quality",folderCine:"🎬 Cinematic",folderCam:"Camera",folderDof:"Depth of Field",folderFx:"Effects",materialBase:"Base Set",materialMix:"Mix",normalStrength:"Normal Strength",displacement:"Displacement",randomizeSeed:"🎲 Randomize Seed",moundScale:"Mound Scale",reliefScale:"Relief Scale",reliefStrength:"Relief Strength",toneColor:"Tone Color",toneCoverage:"Tone Coverage",toneScale:"Tone Scale",moistureLevel:"Moisture Level",moistureCoverage:"Moisture Coverage",moistureScale:"Moisture Scale",moistureEdge:"Moisture Edge",moistureDarken:"Moisture Darken",moistureGloss:"Moisture Gloss",crackStrength:"Crack Strength",crackScale:"Crack Scale",crackEdge:"Crack Edge",crackDepth:"Crack Depth",mossEnabled:"Moss Enabled",mossHeight:"Moss Height",mossCoverage:"Coverage",mossMaskScale:"Mask Scale",mossEdge:"Edge",mossPatchy:"Patchiness",mossHeightVar:"Height Variation",mossRoughness:"Roughness",mossBump:"Bump",mossBumpScale:"Bump Scale",mossSpore:"Spore / Sparkle",modelPick:"Pick Model",modelLoad:"Load .glb…",modelMoss:"Moss Accumulation",accumCoverage:"Coverage",accumScale:"Scale",accumEdge:"Edge",accumHeightVar:"Height Variation",accumSeedX:"Seed X",accumSeedY:"Seed Y",accumRandomize:"🎲 Randomize Seed",grassEnabled:"Grass Enabled",grassCount:"Grass Count",grassCoverage:"Coverage",grassMaskScale:"Mask Scale",grassEdge:"Edge",grassHeight:"Grass Height",grassWidth:"Grass Width",grassTint:"Grass Tint",grassPatchy:"Patchiness",windStrength:"Wind Strength",windSpeed:"Wind Speed",windGust:"Gust Size",windDir:"Wind Direction",windFlutter:"Flutter",exposure:"Exposure",keyLight:"Key Light",fillLight:"Fill Light",rimLight:"Rim Light",ambient:"Ambient",envIntensity:"Env / IBL",cloudsEnabled:"Clouds Enabled",cloudCoverage:"Coverage",cloudDensity:"Density",cloudAltitude:"Altitude",cloudThickness:"Thickness",cloudScale:"Scale",cloudRoundness:"Roundness",cloudWisp:"Wispiness",cloudSpeed:"Speed",cloudSun:"Sun Strength",cloudAmbient:"Ambient",cloudSteps:"Steps",cloudDownres:"Down Resolution",autoOrbit:"Auto Orbit",orbitSpeed:"Orbit Speed",fov:"Focal / FOV",letterbox:"Letterbox",dofEnabled:"Enable DoF",focusDistance:"Focus Distance",aperture:"Aperture",maxBlur:"Max Blur",bloom:"Bloom",bloomRadius:"Bloom Radius",bloomThreshold:"Bloom Threshold",filmGrain:"Film Grain",vignette:"Vignette",chromaticAberration:"Chromatic Aberration",contrast:"Contrast",saturation:"Saturation"};let Xv=Gv;function Z(i){const e=Xv[i];if(e!==void 0)return e;const t=Wv[i];return t!==void 0?t:i}const la={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`};class Xi{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const Yv=new pr(-1,1,1,-1,0,1);class qv extends en{constructor(){super(),this.setAttribute("position",new Jt([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new Jt([0,2,0,0,2,0],2))}}const Kv=new qv;class mr{constructor(e){this._mesh=new ut(Kv,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Yv)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class Jl extends Xi{constructor(e,t="tDiffuse"){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Ct?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ts.clone(e.uniforms),this.material=new Ct({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new mr(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}class Nu extends Xi{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const s=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,a,4294967295),r.buffers.stencil.setClear(o),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}}class $v extends Xi{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class Zv{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new ge);this._width=n.width,this._height=n.height,t=new Ot(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Gt}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Jl(la),this.copyPass.material.blending=Sn,this.timer=new op}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let s=0,r=this.passes.length;s<r;s++){const a=this.passes[s];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){const o=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}Nu!==void 0&&(a instanceof Nu?n=!0:a instanceof $v&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new ge);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(n,s),this.renderTarget2.setSize(n,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,s)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class Jv extends Xi{constructor(e,t,n=null,s=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=s,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Se}render(e,t,n){const s=e.autoClear;e.autoClear=!1;let r,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=s}}const Qr={defines:{DEPTH_PACKING:1,PERSPECTIVE_CAMERA:1},uniforms:{tColor:{value:null},tDepth:{value:null},focus:{value:1},aspect:{value:1},aperture:{value:.025},maxblur:{value:.01},nearClip:{value:1},farClip:{value:1e3}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}As.BlurDirectionX=new ge(1,0);As.BlurDirectionY=new ge(0,1);const ea={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`};class ex extends Xi{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ts.clone(ea.uniforms),this.material=new ph({name:ea.name,uniforms:this.uniforms,vertexShader:ea.vertexShader,fragmentShader:ea.fragmentShader}),this._fsQuad=new mr(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},He.getTransfer(this._outputColorSpace)===Je&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===yl?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===bl?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===El?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===Ma?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===Al?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===wl?this.material.defines.NEUTRAL_TONE_MAPPING="":this._toneMapping===Tl&&(this.material.defines.CUSTOM_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}const _o={uniforms:{tDepth:{value:null},uInvProj:{value:null},uInvView:{value:null},uCameraPos:{value:null},uTime:{value:0},uHalfXZ:{value:10},uBase:{value:10},uHeight:{value:3.2},uHeightFalloff:{value:.8},uDensity:{value:2.6},uCoverage:{value:.6},uCoverageEdge:{value:.18},uNoiseScale:{value:.14},uDetail:{value:.6},uDetailScale:{value:4},uEdgeFade:{value:2},uWindDir:{value:null},uWindSpeed:{value:.15},uSteps:{value:40},uLightSteps:{value:5},uLightStepSize:{value:.5},uAniso:{value:.6},uAmbient:{value:.3},uSunStrength:{value:2.6},uFogColor:{value:null},uSunColor:{value:null},uSunDir:{value:null}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `},tx={uniforms:{tDiffuse:{value:null},tFog:{value:null}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `};function nx({renderer:i,scene:e,camera:t,scale:n=.5}){let s=n;const r=()=>Math.max(1,Math.floor(window.innerWidth*i.getPixelRatio()*s)),a=()=>Math.max(1,Math.floor(window.innerHeight*i.getPixelRatio()*s)),o=new Hi;o.type=En;const l=new Ot(r(),a(),{depthTexture:o,depthBuffer:!0}),c=new Ot(r(),a(),{type:Gt,minFilter:Mt,magFilter:Mt,depthBuffer:!1}),u=new Ct({uniforms:_o.uniforms,vertexShader:_o.vertexShader,fragmentShader:_o.fragmentShader});u.uniforms.tDepth.value=l.depthTexture,u.uniforms.uInvProj.value=new Ne,u.uniforms.uInvView.value=new Ne,u.uniforms.uCameraPos.value=new D,u.uniforms.uWindDir.value=new ge(1,.3).normalize(),u.uniforms.uFogColor.value=new Se(13489885),u.uniforms.uSunColor.value=new Se(16771528),u.uniforms.uSunDir.value=new D(1,1,1).normalize();const d=new mr(u),h=new Jl(tx);h.enabled=!1,h.uniforms.tFog.value=c.texture;function f(){l.setSize(r(),a()),c.setSize(r(),a())}return{compositePass:h,material:u,uniforms:u.uniforms,get enabled(){return h.enabled},setEnabled(g){h.enabled=g},setScale(g){s=g,f()},setSize(){f()},renderVolume(g){const x=i.getRenderTarget();i.setRenderTarget(l),i.render(e,t),u.uniforms.uTime.value+=g,u.uniforms.uInvProj.value.copy(t.projectionMatrixInverse),u.uniforms.uInvView.value.copy(t.matrixWorld),u.uniforms.uCameraPos.value.copy(t.position),i.setRenderTarget(c),d.render(i),i.setRenderTarget(x)},dispose(){l.dispose(),c.dispose(),u.dispose(),d.dispose()}}}const ix={uniforms:{tDiffuse:{value:null},uTime:{value:0},uVignette:{value:.15},uVignetteSize:{value:.4},uGrain:{value:0},uChroma:{value:0},uContrast:{value:1},uSaturation:{value:1}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  vec3 objectNormal = gNrm;`).replace("#include <begin_vertex>","vec3 transformed = gPos;"),v.fragmentShader=v.fragmentShader.replace("#include <common>",`#include <common>
        ...
        `)},E.customProgramCacheKey=()=>"grass-v1";const C=new ut(f,E);return C.frustumCulled=!1,C.castShadow=!1,C.receiveShadow=!0,{mesh:C,material:E,uniforms:T,maxCount:o,setDensity(v){f.instanceCount=Math.floor(o*Wi.clamp(v,0,1))},update(v){T.uCameraPos.value.copy(v),T.uSunDir.value.copy(a.position).normalize()}}}function Uu(i,e){if(e===Ad)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),i;if(e===ol||e===Qu){let t=i.getIndex();if(t===null){const a=[],o=i.getAttribute("position");if(o!==void 0){for(let l=0;l<o.count;l++)a.push(l);i.setIndex(a),t=i.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),i}const n=t.count-2,s=[];if(e===ol)for(let a=1;a<=n;a++)s.push(t.getX(0)),s.push(t.getX(a)),s.push(t.getX(a+1));else for(let a=0;a<n;a++)a%2===0?(s.push(t.getX(a)),s.push(t.getX(a+1)),s.push(t.getX(a+2))):(s.push(t.getX(a+2)),s.push(t.getX(a+1)),s.push(t.getX(a)));s.length/3!==n&&console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.");const r=i.clone();return r.setIndex(s),r.clearGroups(),r}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",e),i}function ax(i){const e=new Map,t=new Map,n=i.clone();return Dh(i,n,function(s,r){e.set(r,s),t.set(s,r)}),n.traverse(function(s){if(!s.isSkinnedMesh)return;const r=s,a=e.get(s),o=a.skeleton.bones;r.skeleton=a.skeleton.clone(),r.bindMatrix.copy(a.bindMatrix),r.skeleton.bones=o.map(function(l){return t.get(l)}),r.bind(r.skeleton,r.bindMatrix)}),n}function Dh(i,e,t){t(i,e);for(let n=0;n<i.children.length;n++)Dh(i.children[n],e.children[n],t)}class ox extends Ls{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(t){return new dx(t)}),this.register(function(t){return new fx(t)}),this.register(function(t){return new yx(t)}),this.register(function(t){return new bx(t)}),this.register(function(t){return new Ex(t)}),this.register(function(t){return new mx(t)}),this.register(function(t){return new gx(t)}),this.register(function(t){return new _x(t)}),this.register(function(t){return new vx(t)}),this.register(function(t){return new hx(t)}),this.register(function(t){return new xx(t)}),this.register(function(t){return new px(t)}),this.register(function(t){return new Sx(t)}),this.register(function(t){return new Mx(t)}),this.register(function(t){return new cx(t)}),this.register(function(t){return new Fu(t,Ge.EXT_MESHOPT_COMPRESSION)}),this.register(function(t){return new Fu(t,Ge.KHR_MESHOPT_COMPRESSION)}),this.register(function(t){return new Tx(t)})}load(e,t,n,s){const r=this;let a;if(this.resourcePath!=="")a=this.resourcePath;else if(this.path!==""){const c=nr.extractUrlBase(e);a=nr.resolveURL(c,this.path)}else a=nr.extractUrlBase(e);this.manager.itemStart(e);const o=function(c){s?s(c):console.error(c),r.manager.itemError(e),r.manager.itemEnd(e)},l=new _h(this.manager);l.setPath(this.path),l.setResponseType("arraybuffer"),l.setRequestHeader(this.requestHeader),l.setWithCredentials(this.withCredentials),l.load(e,function(c){try{r.parse(c,a,function(u){t(u),r.manager.itemEnd(e)},o)}catch(u){o(u)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,s){let r;const a={},o={},l=new TextDecoder;if(typeof e=="string")r=JSON.parse(e);else if(e instanceof ArrayBuffer)if(l.decode(new Uint8Array(e,0,4))===Lh){try{a[Ge.KHR_BINARY_GLTF]=new Ax(e)}catch(d){s&&s(d);return}r=JSON.parse(a[Ge.KHR_BINARY_GLTF].content)}else r=JSON.parse(l.decode(e));else r=e;if(r.asset===void 0||r.asset.version[0]<2){s&&s(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}const c=new kx(r,{path:t||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let u=0;u<this.pluginCallbacks.length;u++){const d=this.pluginCallbacks[u](c);d.name||console.error("THREE.GLTFLoader: Invalid plugin found: missing name"),o[d.name]=d,a[d.name]=!0}if(r.extensionsUsed)for(let u=0;u<r.extensionsUsed.length;++u){const d=r.extensionsUsed[u],h=r.extensionsRequired||[];switch(d){case Ge.KHR_MATERIALS_UNLIT:a[d]=new ux;break;case Ge.KHR_DRACO_MESH_COMPRESSION:a[d]=new wx(r,this.dracoLoader);break;case Ge.KHR_TEXTURE_TRANSFORM:a[d]=new Cx;break;case Ge.KHR_MESH_QUANTIZATION:a[d]=new Rx;break;default:h.indexOf(d)>=0&&o[d]===void 0&&console.warn('THREE.GLTFLoader: Unknown extension "'+d+'".')}}c.setExtensions(a),c.setPlugins(o),c.parse(n,s)}parseAsync(e,t){const n=this;return new Promise(function(s,r){n.parse(e,t,s,r)})}}function lx(){let i={};return{get:function(e){return i[e]},add:function(e,t){i[e]=t},remove:function(e){delete i[e]},removeAll:function(){i={}}}}function St(i,e,t){const n=i.json.materials[e];return n.extensions&&n.extensions[t]?n.extensions[t]:null}const Ge={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_DISPERSION:"KHR_materials_dispersion",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_MATERIALS_BUMP:"EXT_materials_bump",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",KHR_MESHOPT_COMPRESSION:"KHR_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"};class cx{constructor(e){this.parser=e,this.name=Ge.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){const e=this.parser,t=this.parser.json.nodes||[];for(let n=0,s=t.length;n<s;n++){const r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){const t=this.parser,n="light:"+e;let s=t.cache.get(n);if(s)return s;const r=t.json,l=((r.extensions&&r.extensions[this.name]||{}).lights||[])[e];let c;const u=new Se(16777215);l.color!==void 0&&u.setRGB(l.color[0],l.color[1],l.color[2],on);const d=l.range!==void 0?l.range:0;switch(l.type){case"directional":c=new Yl(u),c.target.position.set(0,0,-1),c.add(c.target);break;case"point":c=new Sh(u),c.distance=d;break;case"spot":c=new Mh(u),c.distance=d,l.spot=l.spot||{},l.spot.innerConeAngle=l.spot.innerConeAngle!==void 0?l.spot.innerConeAngle:0,l.spot.outerConeAngle=l.spot.outerConeAngle!==void 0?l.spot.outerConeAngle:Math.PI/4,c.angle=l.spot.outerConeAngle,c.penumbra=1-l.spot.innerConeAngle/l.spot.outerConeAngle,c.target.position.set(0,0,-1),c.add(c.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+l.type)}return c.position.set(0,0,0),Fn(c,l),l.intensity!==void 0&&(c.intensity=l.intensity),c.name=t.createUniqueName(l.name||"light_"+e),s=Promise.resolve(c),t.cache.add(n,s),s}getDependency(e,t){if(e==="light")return this._loadLight(t)}createNodeAttachment(e){const t=this,n=this.parser,r=n.json.nodes[e],o=(r.extensions&&r.extensions[this.name]||{}).light;return o===void 0?null:this._loadLight(o).then(function(l){return n._getNodeRef(t.cache,o,l)})}}class ux{constructor(){this.name=Ge.KHR_MATERIALS_UNLIT}getMaterialType(){return Ei}extendParams(e,t,n){const s=[];e.color=new Se(1,1,1),e.opacity=1;const r=t.pbrMetallicRoughness;if(r){if(Array.isArray(r.baseColorFactor)){const a=r.baseColorFactor;e.color.setRGB(a[0],a[1],a[2],on),e.opacity=a[3]}r.baseColorTexture!==void 0&&s.push(n.assignTexture(e,"map",r.baseColorTexture,Ut))}return Promise.all(s)}}class hx{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){const n=St(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}}class dx{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return St(this.parser,e,this.name)!==null?Yn:null}extendMaterialParams(e,t){const n=St(this.parser,e,this.name);if(n===null)return Promise.resolve();const s=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&s.push(this.parser.assignTexture(t,"clearcoatMap",n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&s.push(this.parser.assignTexture(t,"clearcoatRoughnessMap",n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(s.push(this.parser.assignTexture(t,"clearcoatNormalMap",n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){const r=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new ge(r,r)}return Promise.all(s)}}class fx{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_DISPERSION}getMaterialType(e){return St(this.parser,e,this.name)!==null?Yn:null}extendMaterialParams(e,t){const n=St(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion!==void 0?n.dispersion:0),Promise.resolve()}}class px{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return St(this.parser,e,this.name)!==null?Yn:null}extendMaterialParams(e,t){const n=St(this.parser,e,this.name);if(n===null)return Promise.resolve();const s=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&s.push(this.parser.assignTexture(t,"iridescenceMap",n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&s.push(this.parser.assignTexture(t,"iridescenceThicknessMap",n.iridescenceThicknessTexture)),Promise.all(s)}}class mx{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_SHEEN}getMaterialType(e){return St(this.parser,e,this.name)!==null?Yn:null}extendMaterialParams(e,t){const n=St(this.parser,e,this.name);if(n===null)return Promise.resolve();const s=[];if(t.sheenColor=new Se(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){const r=n.sheenColorFactor;t.sheenColor.setRGB(r[0],r[1],r[2],on)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&s.push(this.parser.assignTexture(t,"sheenColorMap",n.sheenColorTexture,Ut)),n.sheenRoughnessTexture!==void 0&&s.push(this.parser.assignTexture(t,"sheenRoughnessMap",n.sheenRoughnessTexture)),Promise.all(s)}}class gx{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return St(this.parser,e,this.name)!==null?Yn:null}extendMaterialParams(e,t){const n=St(this.parser,e,this.name);if(n===null)return Promise.resolve();const s=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&s.push(this.parser.assignTexture(t,"transmissionMap",n.transmissionTexture)),Promise.all(s)}}class _x{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_VOLUME}getMaterialType(e){return St(this.parser,e,this.name)!==null?Yn:null}extendMaterialParams(e,t){const n=St(this.parser,e,this.name);if(n===null)return Promise.resolve();const s=[];t.thickness=n.thicknessFactor!==void 0?n.thicknessFactor:0,n.thicknessTexture!==void 0&&s.push(this.parser.assignTexture(t,"thicknessMap",n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;const r=n.attenuationColor||[1,1,1];return t.attenuationColor=new Se().setRGB(r[0],r[1],r[2],on),Promise.all(s)}}class vx{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_IOR}getMaterialType(e){return St(this.parser,e,this.name)!==null?Yn:null}extendMaterialParams(e,t){const n=St(this.parser,e,this.name);return n===null||(t.ior=n.ior!==void 0?n.ior:1.5,t.ior===0&&(t.ior=1e3)),Promise.resolve()}}class xx{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_SPECULAR}getMaterialType(e){return St(this.parser,e,this.name)!==null?Yn:null}extendMaterialParams(e,t){const n=St(this.parser,e,this.name);if(n===null)return Promise.resolve();const s=[];t.specularIntensity=n.specularFactor!==void 0?n.specularFactor:1,n.specularTexture!==void 0&&s.push(this.parser.assignTexture(t,"specularIntensityMap",n.specularTexture));const r=n.specularColorFactor||[1,1,1];return t.specularColor=new Se().setRGB(r[0],r[1],r[2],on),n.specularColorTexture!==void 0&&s.push(this.parser.assignTexture(t,"specularColorMap",n.specularColorTexture,Ut)),Promise.all(s)}}class Mx{constructor(e){this.parser=e,this.name=Ge.EXT_MATERIALS_BUMP}getMaterialType(e){return St(this.parser,e,this.name)!==null?Yn:null}extendMaterialParams(e,t){const n=St(this.parser,e,this.name);if(n===null)return Promise.resolve();const s=[];return t.bumpScale=n.bumpFactor!==void 0?n.bumpFactor:1,n.bumpTexture!==void 0&&s.push(this.parser.assignTexture(t,"bumpMap",n.bumpTexture)),Promise.all(s)}}class Sx{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return St(this.parser,e,this.name)!==null?Yn:null}extendMaterialParams(e,t){const n=St(this.parser,e,this.name);if(n===null)return Promise.resolve();const s=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&s.push(this.parser.assignTexture(t,"anisotropyMap",n.anisotropyTexture)),Promise.all(s)}}class yx{constructor(e){this.parser=e,this.name=Ge.KHR_TEXTURE_BASISU}loadTexture(e){const t=this.parser,n=t.json,s=n.textures[e];if(!s.extensions||!s.extensions[this.name])return null;const r=s.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return t.loadTextureImage(e,r.source,a)}}class bx{constructor(e){this.parser=e,this.name=Ge.EXT_TEXTURE_WEBP}loadTexture(e){const t=this.name,n=this.parser,s=n.json,r=s.textures[e];if(!r.extensions||!r.extensions[t])return null;const a=r.extensions[t],o=s.images[a.source];let l=n.textureLoader;if(o.uri){const c=n.options.manager.getHandler(o.uri);c!==null&&(l=c)}return n.loadTextureImage(e,a.source,l)}}class Ex{constructor(e){this.parser=e,this.name=Ge.EXT_TEXTURE_AVIF}loadTexture(e){const t=this.name,n=this.parser,s=n.json,r=s.textures[e];if(!r.extensions||!r.extensions[t])return null;const a=r.extensions[t],o=s.images[a.source];let l=n.textureLoader;if(o.uri){const c=n.options.manager.getHandler(o.uri);c!==null&&(l=c)}return n.loadTextureImage(e,a.source,l)}}class Fu{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){const t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){const s=n.extensions[this.name],r=this.parser.getDependency("buffer",s.buffer),a=this.parser.options.meshoptDecoder;if(!a||!a.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return r.then(function(o){const l=s.byteOffset||0,c=s.byteLength||0,u=s.count,d=s.byteStride,h=new Uint8Array(o,l,c);return a.decodeGltfBufferAsync?a.decodeGltfBufferAsync(u,d,h,s.mode,s.filter).then(function(f){return f.buffer}):a.ready.then(function(){const f=new ArrayBuffer(u*d);return a.decodeGltfBuffer(new Uint8Array(f),u,d,h,s.mode,s.filter),f})})}else return null}}class Tx{constructor(e){this.name=Ge.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){const t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;const s=t.meshes[n.mesh];for(const c of s.primitives)if(c.mode!==hn.TRIANGLES&&c.mode!==hn.TRIANGLE_STRIP&&c.mode!==hn.TRIANGLE_FAN&&c.mode!==void 0)return null;const a=n.extensions[this.name].attributes,o=[],l={};for(const c in a)o.push(this.parser.getDependency("accessor",a[c]).then(u=>(l[c]=u,l[c])));return o.length<1?null:(o.push(this.parser.createNodeMesh(e)),Promise.all(o).then(c=>{const u=c.pop(),d=u.isGroup?u.children:[u],h=c[0].count,f=[];for(const g of d){const x=new Ne,m=new D,p=new Tn,y=new D(1,1,1),w=new lh(g.geometry,g.material,h);for(let S=0;S<h;S++)l.TRANSLATION&&m.fromBufferAttribute(l.TRANSLATION,S),l.ROTATION&&p.fromBufferAttribute(l.ROTATION,S),l.SCALE&&y.fromBufferAttribute(l.SCALE,S),w.setMatrixAt(S,x.compose(m,p,y));for(const S in l)if(S==="_COLOR_0"){const T=l[S];w.instanceColor=new On(T.array,T.itemSize,T.normalized)}else S!=="TRANSLATION"&&S!=="ROTATION"&&S!=="SCALE"&&g.geometry.setAttribute(S,l[S]);ht.prototype.copy.call(w,g),this.parser.assignFinalMaterial(w),f.push(w)}return u.isGroup?(u.clear(),u.add(...f),u):f[0]}))}}const Lh="glTF",Zs=12,Ou={JSON:1313821514,BIN:5130562};class Ax{constructor(e){this.name=Ge.KHR_BINARY_GLTF,this.content=null,this.body=null;const t=new DataView(e,0,Zs),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==Lh)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");const s=this.header.length-Zs,r=new DataView(e,Zs);let a=0;for(;a<s;){const o=r.getUint32(a,!0);a+=4;const l=r.getUint32(a,!0);if(a+=4,l===Ou.JSON){const c=new Uint8Array(e,Zs+a,o);this.content=n.decode(c)}else if(l===Ou.BIN){const c=Zs+a;this.body=e.slice(c,c+o)}a+=o}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}}class wx{constructor(e,t){if(!t)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=Ge.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){const n=this.json,s=this.dracoLoader,r=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},l={},c={};for(const u in a){const d=pl[u]||u.toLowerCase();o[d]=a[u]}for(const u in e.attributes){const d=pl[u]||u.toLowerCase();if(a[u]!==void 0){const h=n.accessors[e.attributes[u]],f=Ms[h.componentType];c[d]=f.name,l[d]=h.normalized===!0}}return t.getDependency("bufferView",r).then(function(u){return new Promise(function(d,h){s.decodeDracoFile(u,function(f){for(const g in f.attributes){const x=f.attributes[g],m=l[g];m!==void 0&&(x.normalized=m)}d(f)},o,c,on,h)})})}}class Cx{constructor(){this.name=Ge.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0||(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0),e}}class Rx{constructor(){this.name=Ge.KHR_MESH_QUANTIZATION}}class Ih extends Rs{constructor(e,t,n,s){super(e,t,n,s)}copySampleValue_(e){const t=this.resultBuffer,n=this.sampleValues,s=this.valueSize,r=e*s*3+s;for(let a=0;a!==s;a++)t[a]=n[r+a];return t}interpolate_(e,t,n,s){const r=this.resultBuffer,a=this.sampleValues,o=this.valueSize,l=o*2,c=o*3,u=s-t,d=(n-t)/u,h=d*d,f=h*d,g=e*c,x=g-c,m=-2*f+3*h,p=f-h,y=1-m,w=p-h+d;for(let S=0;S!==o;S++){const T=a[x+S+o],E=a[x+S+l]*u,C=a[g+S+o],v=a[g+S]*u;r[S]=y*T+w*E+m*C+p*v}return r}}const Px=new Tn;class Dx extends Ih{interpolate_(e,t,n,s){const r=super.interpolate_(e,t,n,s);return Px.fromArray(r).normalize().toArray(r),r}}const hn={POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6},Ms={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Bu={9728:xt,9729:Mt,9984:Yu,9985:na,9986:js,9987:ni},ku={33071:Vn,33648:ua,10497:Ai},vo={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},pl={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},Mi={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},Lx={CUBICSPLINE:void 0,LINEAR:ar,STEP:rr},xo={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function Ix(i){return i.DefaultMaterial===void 0&&(i.DefaultMaterial=new Gi({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:ri})),i.DefaultMaterial}function Fi(i,e,t){for(const n in t.extensions)i[n]===void 0&&(e.userData.gltfExtensions=e.userData.gltfExtensions||{},e.userData.gltfExtensions[n]=t.extensions[n])}function Fn(i,e){e.extras!==void 0&&(typeof e.extras=="object"?Object.assign(i.userData,e.extras):console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+e.extras))}function Nx(i,e,t){let n=!1,s=!1,r=!1;for(let c=0,u=e.length;c<u;c++){const d=e[c];if(d.POSITION!==void 0&&(n=!0),d.NORMAL!==void 0&&(s=!0),d.COLOR_0!==void 0&&(r=!0),n&&s&&r)break}if(!n&&!s&&!r)return Promise.resolve(i);const a=[],o=[],l=[];for(let c=0,u=e.length;c<u;c++){const d=e[c];if(n){const h=d.POSITION!==void 0?t.getDependency("accessor",d.POSITION):i.attributes.position;a.push(h)}if(s){const h=d.NORMAL!==void 0?t.getDependency("accessor",d.NORMAL):i.attributes.normal;o.push(h)}if(r){const h=d.COLOR_0!==void 0?t.getDependency("accessor",d.COLOR_0):i.attributes.color;l.push(h)}}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(l)]).then(function(c){const u=c[0],d=c[1],h=c[2];return n&&(i.morphAttributes.position=u),s&&(i.morphAttributes.normal=d),r&&(i.morphAttributes.color=h),i.morphTargetsRelative=!0,i})}function Ux(i,e){if(i.updateMorphTargets(),e.weights!==void 0)for(let t=0,n=e.weights.length;t<n;t++)i.morphTargetInfluences[t]=e.weights[t];if(e.extras&&Array.isArray(e.extras.targetNames)){const t=e.extras.targetNames;if(i.morphTargetInfluences.length===t.length){i.morphTargetDictionary={};for(let n=0,s=t.length;n<s;n++)i.morphTargetDictionary[t[n]]=n}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function Fx(i){let e;const t=i.extensions&&i.extensions[Ge.KHR_DRACO_MESH_COMPRESSION];if(t?e="draco:"+t.bufferView+":"+t.indices+":"+Mo(t.attributes):e=i.indices+":"+Mo(i.attributes)+":"+i.mode,i.targets!==void 0)for(let n=0,s=i.targets.length;n<s;n++)e+=":"+Mo(i.targets[n]);return e}function Mo(i){let e="";const t=Object.keys(i).sort();for(let n=0,s=t.length;n<s;n++)e+=t[n]+":"+i[t[n]]+";";return e}function ml(i){switch(i){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function Ox(i){return i.search(/\.jpe?g($|\?)/i)>0||i.search(/^data\:image\/jpeg/)===0?"image/jpeg":i.search(/\.webp($|\?)/i)>0||i.search(/^data\:image\/webp/)===0?"image/webp":i.search(/\.ktx2($|\?)/i)>0||i.search(/^data\:image\/ktx2/)===0?"image/ktx2":"image/png"}const Bx=new Ne;class kx{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new lx,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,s=-1,r=!1,a=-1;if(typeof navigator<"u"&&typeof navigator.userAgent<"u"){const o=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(o)===!0;const l=o.match(/Version\/(\d+)/);s=n&&l?parseInt(l[1],10):-1,r=o.indexOf("Firefox")>-1,a=r?o.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>"u"||n&&s<17||r&&a<98?this.textureLoader=new vh(this.options.manager):this.textureLoader=new sp(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new _h(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){const n=this,s=this.json,r=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(a){return a._markDefs&&a._markDefs()}),Promise.all(this._invokeAll(function(a){return a.beforeRoot&&a.beforeRoot()})).then(function(){return Promise.all([n.getDependencies("scene"),n.getDependencies("animation"),n.getDependencies("camera")])}).then(function(a){const o={scene:a[0][s.scene||0],scenes:a[0],animations:a[1],cameras:a[2],asset:s.asset,parser:n,userData:{}};return Fi(r,o,s),Fn(o,s),Promise.all(n._invokeAll(function(l){return l.afterRoot&&l.afterRoot(o)})).then(function(){for(const l of o.scenes)l.updateMatrixWorld();e(o)})}).catch(t)}_markDefs(){const e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let s=0,r=t.length;s<r;s++){const a=t[s].joints;for(let o=0,l=a.length;o<l;o++)e[a[o]].isBone=!0}for(let s=0,r=e.length;s<r;s++){const a=e[s];a.mesh!==void 0&&(this._addNodeRef(this.meshCache,a.mesh),a.skin!==void 0&&(n[a.mesh].isSkinnedMesh=!0)),a.camera!==void 0&&this._addNodeRef(this.cameraCache,a.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;const s=n.clone(),r=(a,o)=>{const l=this.associations.get(a);l!=null&&this.associations.set(o,l);for(const[c,u]of a.children.entries())r(u,o.children[c])};return r(n,s),s.name+="_instance_"+e.uses[t]++,s}_invokeOne(e){const t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){const s=e(t[n]);if(s)return s}return null}_invokeAll(e){const t=Object.values(this.plugins);t.unshift(this);const n=[];for(let s=0;s<t.length;s++){const r=e(t[s]);r&&n.push(r)}return n}getDependency(e,t){const n=e+":"+t;let s=this.cache.get(n);if(!s){switch(e){case"scene":s=this.loadScene(t);break;case"node":s=this._invokeOne(function(r){return r.loadNode&&r.loadNode(t)});break;case"mesh":s=this._invokeOne(function(r){return r.loadMesh&&r.loadMesh(t)});break;case"accessor":s=this.loadAccessor(t);break;case"bufferView":s=this._invokeOne(function(r){return r.loadBufferView&&r.loadBufferView(t)});break;case"buffer":s=this.loadBuffer(t);break;case"material":s=this._invokeOne(function(r){return r.loadMaterial&&r.loadMaterial(t)});break;case"texture":s=this._invokeOne(function(r){return r.loadTexture&&r.loadTexture(t)});break;case"skin":s=this.loadSkin(t);break;case"animation":s=this._invokeOne(function(r){return r.loadAnimation&&r.loadAnimation(t)});break;case"camera":s=this.loadCamera(t);break;default:if(s=this._invokeOne(function(r){return r!=this&&r.getDependency&&r.getDependency(e,t)}),!s)throw new Error("Unknown type: "+e);break}this.cache.add(n,s)}return s}getDependencies(e){let t=this.cache.get(e);if(!t){const n=this,s=this.json[e+(e==="mesh"?"es":"s")]||[];t=Promise.all(s.map(function(r,a){return n.getDependency(e,a)})),this.cache.add(e,t)}return t}loadBuffer(e){const t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+t.type+" buffer type is not supported.");if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[Ge.KHR_BINARY_GLTF].body);const s=this.options;return new Promise(function(r,a){n.load(nr.resolveURL(t.uri,s.path),r,void 0,function(){a(new Error('THREE.GLTFLoader: Failed to load buffer "'+t.uri+'".'))})})}loadBufferView(e){const t=this.json.bufferViews[e];return this.getDependency("buffer",t.buffer).then(function(n){const s=t.byteLength||0,r=t.byteOffset||0;return n.slice(r,r+s)})}loadAccessor(e){const t=this,n=this.json,s=this.json.accessors[e];if(s.bufferView===void 0&&s.sparse===void 0){const a=vo[s.type],o=Ms[s.componentType],l=s.normalized===!0,c=new o(s.count*a);return Promise.resolve(new Zt(c,a,l))}const r=[];return s.bufferView!==void 0?r.push(this.getDependency("bufferView",s.bufferView)):r.push(null),s.sparse!==void 0&&(r.push(this.getDependency("bufferView",s.sparse.indices.bufferView)),r.push(this.getDependency("bufferView",s.sparse.values.bufferView))),Promise.all(r).then(function(a){const o=a[0],l=vo[s.type],c=Ms[s.componentType],u=c.BYTES_PER_ELEMENT,d=u*l,h=s.byteOffset||0,f=s.bufferView!==void 0?n.bufferViews[s.bufferView].byteStride:void 0,g=s.normalized===!0;let x,m;if(f&&f!==d){const p=Math.floor(h/f),y="InterleavedBuffer:"+s.bufferView+":"+s.componentType+":"+p+":"+s.count;let w=t.cache.get(y);w||(x=new c(o,p*f,s.count*f/u),w=new Mf(x,f/u),t.cache.add(y,w)),m=new zl(w,l,h%f/u,g)}else o===null?x=new c(s.count*l):x=new c(o,h,s.count*l),m=new Zt(x,l,g);if(s.sparse!==void 0){const p=vo.SCALAR,y=Ms[s.sparse.indices.componentType],w=s.sparse.indices.byteOffset||0,S=s.sparse.values.byteOffset||0,T=new y(a[1],w,s.sparse.count*p),E=new c(a[2],S,s.sparse.count*l);o!==null&&(m=new Zt(m.array.slice(),m.itemSize,m.normalized)),m.normalized=!1;for(let C=0,v=T.length;C<v;C++){const A=T[C];if(m.setX(A,E[C*l]),l>=2&&m.setY(A,E[C*l+1]),l>=3&&m.setZ(A,E[C*l+2]),l>=4&&m.setW(A,E[C*l+3]),l>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}m.normalized=g}return m})}loadTexture(e){const t=this.json,n=this.options,r=t.textures[e].source,a=t.images[r];let o=this.textureLoader;if(a.uri){const l=n.manager.getHandler(a.uri);l!==null&&(o=l)}return this.loadTextureImage(e,r,o)}loadTextureImage(e,t,n){const s=this,r=this.json,a=r.textures[e],o=r.images[t],l=(o.uri||o.bufferView)+":"+a.sampler;if(this.textureCache[l])return this.textureCache[l];const c=this.loadImageSource(t,n).then(function(u){u.flipY=!1,u.name=a.name||o.name||"",u.name===""&&typeof o.uri=="string"&&o.uri.startsWith("data:image/")===!1&&(u.name=o.uri);const h=(r.samplers||{})[a.sampler]||{};return u.magFilter=Bu[h.magFilter]||Mt,u.minFilter=Bu[h.minFilter]||ni,u.wrapS=ku[h.wrapS]||Ai,u.wrapT=ku[h.wrapT]||Ai,u.generateMipmaps=!u.isCompressedTexture&&u.minFilter!==xt&&u.minFilter!==Mt,s.associations.set(u,{textures:e}),u}).catch(function(){return null});return this.textureCache[l]=c,c}loadImageSource(e,t){const n=this,s=this.json,r=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(d=>d.clone());const a=s.images[e],o=self.URL||self.webkitURL;let l=a.uri||"",c=!1;if(a.bufferView!==void 0)l=n.getDependency("bufferView",a.bufferView).then(function(d){c=!0;const h=new Blob([d],{type:a.mimeType});return l=o.createObjectURL(h),l});else if(a.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+e+" is missing URI and bufferView");const u=Promise.resolve(l).then(function(d){return new Promise(function(h,f){let g=h;t.isImageBitmapLoader===!0&&(g=function(x){const m=new Ft(x);m.needsUpdate=!0,h(m)}),t.load(nr.resolveURL(d,r.path),g,void 0,f)})}).then(function(d){return c===!0&&o.revokeObjectURL(l),Fn(d,a),d.userData.mimeType=a.mimeType||Ox(a.uri),d}).catch(function(d){throw console.error("THREE.GLTFLoader: Couldn't load texture",l),d});return this.sourceCache[e]=u,u}assignTexture(e,t,n,s){const r=this;return this.getDependency("texture",n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),r.extensions[Ge.KHR_TEXTURE_TRANSFORM]){const o=n.extensions!==void 0?n.extensions[Ge.KHR_TEXTURE_TRANSFORM]:void 0;if(o){const l=r.associations.get(a);a=r.extensions[Ge.KHR_TEXTURE_TRANSFORM].extendTexture(a,o),r.associations.set(a,l)}}return s!==void 0&&(a.colorSpace=s),e[t]=a,a})}assignFinalMaterial(e){const t=e.geometry;let n=e.material;const s=t.attributes.tangent===void 0,r=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){const o="PointsMaterial:"+n.uuid;let l=this.cache.get(o);l||(l=new uh,bn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,l.sizeAttenuation=!1,this.cache.add(o,l)),n=l}else if(e.isLine){const o="LineBasicMaterial:"+n.uuid;let l=this.cache.get(o);l||(l=new ch,bn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,this.cache.add(o,l)),n=l}if(s||r||a){let o="ClonedMaterial:"+n.uuid+":";s&&(o+="derivative-tangents:"),r&&(o+="vertex-colors:"),a&&(o+="flat-shading:");let l=this.cache.get(o);l||(l=n.clone(),r&&(l.vertexColors=!0),a&&(l.flatShading=!0),s&&(l.normalScale&&(l.normalScale.y*=-1),l.clearcoatNormalScale&&(l.clearcoatNormalScale.y*=-1)),this.cache.add(o,l),this.associations.set(l,this.associations.get(n))),n=l}e.material=n}getMaterialType(){return Gi}loadMaterial(e){const t=this,n=this.json,s=this.extensions,r=n.materials[e];let a;const o={},l=r.extensions||{},c=[];if(l[Ge.KHR_MATERIALS_UNLIT]){const d=s[Ge.KHR_MATERIALS_UNLIT];a=d.getMaterialType(),c.push(d.extendParams(o,r,t))}else{const d=r.pbrMetallicRoughness||{};if(o.color=new Se(1,1,1),o.opacity=1,Array.isArray(d.baseColorFactor)){const h=d.baseColorFactor;o.color.setRGB(h[0],h[1],h[2],on),o.opacity=h[3]}d.baseColorTexture!==void 0&&c.push(t.assignTexture(o,"map",d.baseColorTexture,Ut)),o.metalness=d.metallicFactor!==void 0?d.metallicFactor:1,o.roughness=d.roughnessFactor!==void 0?d.roughnessFactor:1,d.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,"metalnessMap",d.metallicRoughnessTexture)),c.push(t.assignTexture(o,"roughnessMap",d.metallicRoughnessTexture))),a=this._invokeOne(function(h){return h.getMaterialType&&h.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(h){return h.extendMaterialParams&&h.extendMaterialParams(e,o)})))}r.doubleSided===!0&&(o.side=dn);const u=r.alphaMode||xo.OPAQUE;if(u===xo.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,u===xo.MASK&&(o.alphaTest=r.alphaCutoff!==void 0?r.alphaCutoff:.5)),r.normalTexture!==void 0&&a!==Ei&&(c.push(t.assignTexture(o,"normalMap",r.normalTexture)),o.normalScale=new ge(1,1),r.normalTexture.scale!==void 0)){const d=r.normalTexture.scale;o.normalScale.set(d,d)}if(r.occlusionTexture!==void 0&&a!==Ei&&(c.push(t.assignTexture(o,"aoMap",r.occlusionTexture)),r.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=r.occlusionTexture.strength)),r.emissiveFactor!==void 0&&a!==Ei){const d=r.emissiveFactor;o.emissive=new Se().setRGB(d[0],d[1],d[2],on)}return r.emissiveTexture!==void 0&&a!==Ei&&c.push(t.assignTexture(o,"emissiveMap",r.emissiveTexture,Ut)),Promise.all(c).then(function(){const d=new a(o);return r.name&&(d.name=r.name),Fn(d,r),t.associations.set(d,{materials:e}),r.extensions&&Fi(s,d,r),d})}createUniqueName(e){const t=et.sanitizeNodeName(e||"");return t in this.nodeNamesUsed?t+"_"+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){const t=this,n=this.extensions,s=this.primitiveCache;function r(o){return n[Ge.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(o,t).then(function(l){return zu(l,o,t)})}const a=[];for(let o=0,l=e.length;o<l;o++){const c=e[o],u=Fx(c),d=s[u];if(d)a.push(d.promise);else{let h;c.extensions&&c.extensions[Ge.KHR_DRACO_MESH_COMPRESSION]?h=r(c):h=zu(new en,c,t),s[u]={primitive:c,promise:h},a.push(h)}}return Promise.all(a)}loadMesh(e){const t=this,n=this.json,s=this.extensions,r=n.meshes[e],a=r.primitives,o=[];for(let l=0,c=a.length;l<c;l++){const u=a[l].material===void 0?Ix(this.cache):this.getDependency("material",a[l].material);o.push(u)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(l){const c=l.slice(0,l.length-1),u=l[l.length-1],d=[];for(let f=0,g=u.length;f<g;f++){const x=u[f],m=a[f];let p;const y=c[f];if(m.mode===hn.TRIANGLES||m.mode===hn.TRIANGLE_STRIP||m.mode===hn.TRIANGLE_FAN||m.mode===void 0)p=r.isSkinnedMesh===!0?new Ef(x,y):new ut(x,y),p.isSkinnedMesh===!0&&p.normalizeSkinWeights(),m.mode===hn.TRIANGLE_STRIP?p.geometry=Uu(p.geometry,Qu):m.mode===hn.TRIANGLE_FAN&&(p.geometry=Uu(p.geometry,ol));else if(m.mode===hn.LINES)p=new Pf(x,y);else if(m.mode===hn.LINE_STRIP)p=new Wl(x,y);else if(m.mode===hn.LINE_LOOP)p=new Df(x,y);else if(m.mode===hn.POINTS)p=new Lf(x,y);else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+m.mode);Object.keys(p.geometry.morphAttributes).length>0&&Ux(p,r),p.name=t.createUniqueName(r.name||"mesh_"+e),Fn(p,r),m.extensions&&Fi(s,p,m),t.assignFinalMaterial(p),d.push(p)}for(let f=0,g=d.length;f<g;f++)t.associations.set(d[f],{meshes:e,primitives:f});if(d.length===1)return r.extensions&&Fi(s,d[0],r),d[0];const h=new bi;r.extensions&&Fi(s,h,r),t.associations.set(h,{meshes:e});for(let f=0,g=d.length;f<g;f++)h.add(d[f]);return h})}loadCamera(e){let t;const n=this.json.cameras[e],s=n[n.type];if(!s){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}return n.type==="perspective"?t=new qt(Wi.radToDeg(s.yfov),s.aspectRatio||1,s.znear||1,s.zfar||2e6):n.type==="orthographic"&&(t=new pr(-s.xmag,s.xmag,s.ymag,-s.ymag,s.znear,s.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),Fn(t,n),Promise.resolve(t)}loadSkin(e){const t=this.json.skins[e],n=[];for(let s=0,r=t.joints.length;s<r;s++)n.push(this._loadNodeShallow(t.joints[s]));return t.inverseBindMatrices!==void 0?n.push(this.getDependency("accessor",t.inverseBindMatrices)):n.push(null),Promise.all(n).then(function(s){const r=s.pop(),a=s,o=[],l=[];for(let c=0,u=a.length;c<u;c++){const d=a[c];if(d){o.push(d);const h=new Ne;r!==null&&h.fromArray(r.array,c*16),l.push(h)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',t.joints[c])}return new Hl(o,l)})}loadAnimation(e){const t=this.json,n=this,s=t.animations[e],r=s.name?s.name:"animation_"+e,a=[],o=[],l=[],c=[],u=[];for(let d=0,h=s.channels.length;d<h;d++){const f=s.channels[d],g=s.samplers[f.sampler],x=f.target,m=x.node,p=s.parameters!==void 0?s.parameters[g.input]:g.input,y=s.parameters!==void 0?s.parameters[g.output]:g.output;x.node!==void 0&&(a.push(this.getDependency("node",m)),o.push(this.getDependency("accessor",p)),l.push(this.getDependency("accessor",y)),c.push(g),u.push(x))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(l),Promise.all(c),Promise.all(u)]).then(function(d){const h=d[0],f=d[1],g=d[2],x=d[3],m=d[4],p=[];for(let w=0,S=h.length;w<S;w++){const T=h[w],E=f[w],C=g[w],v=x[w],A=m[w];if(T===void 0)continue;T.updateMatrix&&T.updateMatrix();const L=n._createAnimationTracks(T,E,C,v,A);if(L)for(let R=0;R<L.length;R++)p.push(L[R])}const y=new Yf(r,void 0,p);return Fn(y,s),y})}createNodeMesh(e){const t=this.json,n=this,s=t.nodes[e];return s.mesh===void 0?null:n.getDependency("mesh",s.mesh).then(function(r){const a=n._getNodeRef(n.meshCache,s.mesh,r);return s.weights!==void 0&&a.traverse(function(o){if(o.isMesh)for(let l=0,c=s.weights.length;l<c;l++)o.morphTargetInfluences[l]=s.weights[l]}),a})}loadNode(e){const t=this.json,n=this,s=t.nodes[e],r=n._loadNodeShallow(e),a=[],o=s.children||[];for(let c=0,u=o.length;c<u;c++)a.push(n.getDependency("node",o[c]));const l=s.skin===void 0?Promise.resolve(null):n.getDependency("skin",s.skin);return Promise.all([r,Promise.all(a),l]).then(function(c){const u=c[0],d=c[1],h=c[2];h!==null&&u.traverse(function(f){f.isSkinnedMesh&&f.bind(h,Bx)});for(let f=0,g=d.length;f<g;f++)u.add(d[f]);if(u.userData.pivot!==void 0&&d.length>0){const f=u.userData.pivot,g=d[0];u.pivot=new D().fromArray(f),u.position.x-=f[0],u.position.y-=f[1],u.position.z-=f[2],g.position.set(0,0,0),delete u.userData.pivot}return u})}_loadNodeShallow(e){const t=this.json,n=this.extensions,s=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];const r=t.nodes[e],a=r.name?s.createUniqueName(r.name):"",o=[],l=s._invokeOne(function(c){return c.createNodeMesh&&c.createNodeMesh(e)});return l&&o.push(l),r.camera!==void 0&&o.push(s.getDependency("camera",r.camera).then(function(c){return s._getNodeRef(s.cameraCache,r.camera,c)})),s._invokeAll(function(c){return c.createNodeAttachment&&c.createNodeAttachment(e)}).forEach(function(c){o.push(c)}),this.nodeCache[e]=Promise.all(o).then(function(c){let u;if(r.isBone===!0?u=new oh:c.length>1?u=new bi:c.length===1?u=c[0]:u=new ht,u!==c[0])for(let d=0,h=c.length;d<h;d++)u.add(c[d]);if(r.name&&(u.userData.name=r.name,u.name=a),Fn(u,r),r.extensions&&Fi(n,u,r),r.matrix!==void 0){const d=new Ne;d.fromArray(r.matrix),u.applyMatrix4(d)}else r.translation!==void 0&&u.position.fromArray(r.translation),r.rotation!==void 0&&u.quaternion.fromArray(r.rotation),r.scale!==void 0&&u.scale.fromArray(r.scale);if(!s.associations.has(u))s.associations.set(u,{});else if(r.mesh!==void 0&&s.meshCache.refs[r.mesh]>1){const d=s.associations.get(u);s.associations.set(u,{...d})}return s.associations.get(u).nodes=e,u}),this.nodeCache[e]}loadScene(e){const t=this.extensions,n=this.json.scenes[e],s=this,r=new bi;n.name&&(r.name=s.createUniqueName(n.name)),Fn(r,n),n.extensions&&Fi(t,r,n);const a=n.nodes||[],o=[];for(let l=0,c=a.length;l<c;l++)o.push(s.getDependency("node",a[l]));return Promise.all(o).then(function(l){for(let u=0,d=l.length;u<d;u++){const h=l[u];h.parent!==null?r.add(ax(h)):r.add(h)}const c=u=>{const d=new Map;for(const[h,f]of s.associations)(h instanceof bn||h instanceof Ft)&&d.set(h,f);return u.traverse(h=>{const f=s.associations.get(h);f!=null&&d.set(h,f)}),d};return s.associations=c(r),r})}_createAnimationTracks(e,t,n,s,r){const a=[],o=e.name?e.name:e.uuid,l=[];function c(f){f.morphTargetInfluences&&l.push(f.name?f.name:f.uuid)}Mi[r.path]===Mi.weights?(c(e),e.isGroup&&e.children.forEach(c)):l.push(o);let u;switch(Mi[r.path]){case Mi.weights:u=ur;break;case Mi.rotation:u=hr;break;case Mi.translation:case Mi.scale:u=_a;break;default:switch(n.itemSize){case 1:u=ur;break;case 2:case 3:default:u=_a;break}break}const d=s.interpolation!==void 0?Lx[s.interpolation]:ar,h=this._getArrayFromAccessor(n);for(let f=0,g=l.length;f<g;f++){const x=new u(l[f]+"."+Mi[r.path],t.array,h,d);s.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(x),a.push(x)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){const n=ml(t.constructor),s=new Float32Array(t.length);for(let r=0,a=t.length;r<a;r++)s[r]=t[r]*n;t=s}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(n){const s=this instanceof hr?Dx:Ih;return new s(this.times,this.values,this.getValueSize()/3,n)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}}function zx(i,e,t){const n=e.attributes,s=new Xn;if(n.POSITION!==void 0){const o=t.json.accessors[n.POSITION],l=o.min,c=o.max;if(l!==void 0&&c!==void 0){if(s.set(new D(l[0],l[1],l[2]),new D(c[0],c[1],c[2])),o.normalized){const u=ml(Ms[o.componentType]);s.min.multiplyScalar(u),s.max.multiplyScalar(u)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;const r=e.targets;if(r!==void 0){const o=new D,l=new D;for(let c=0,u=r.length;c<u;c++){const d=r[c];if(d.POSITION!==void 0){const h=t.json.accessors[d.POSITION],f=h.min,g=h.max;if(f!==void 0&&g!==void 0){if(l.setX(Math.max(Math.abs(f[0]),Math.abs(g[0]))),l.setY(Math.max(Math.abs(f[1]),Math.abs(g[1]))),l.setZ(Math.max(Math.abs(f[2]),Math.abs(g[2]))),h.normalized){const x=ml(Ms[h.componentType]);l.multiplyScalar(x)}o.max(l)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}s.expandByVector(o)}i.boundingBox=s;const a=new An;s.getCenter(a.center),a.radius=s.min.distanceTo(s.max)/2,i.boundingSphere=a}function zu(i,e,t){const n=e.attributes,s=[];function r(a,o){return t.getDependency("accessor",a).then(function(l){i.setAttribute(o,l)})}for(const a in n){const o=pl[a]||a.toLowerCase();o in i.attributes||s.push(r(n[a],o))}if(e.indices!==void 0&&!i.index){const a=t.getDependency("accessor",e.indices).then(function(o){i.setIndex(o)});s.push(a)}return He.workingColorSpace!==on&&"COLOR_0"in n&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${He.workingColorSpace}" not supported.`),Fn(i,e),zx(i,e,t),Promise.all(s).then(function(){return e.targets!==void 0?Nx(i,e.targets,t):i})}function Vx({scene:i,sharedUniforms:e,mossUniforms:t,defaultUrl:n}){const s=new ox,r=new bi;r.visible=!1,i.add(r);let a=null;const o=new Set,l={uMossEnabled:t.uMossEnabled,uModelInv:{value:new Ne},uMossSeed:{value:new ge(3,7)},uMossScale:{value:.9},uMossCoverage:{value:.7},uMossEdge:{value:.15},uMossThickness:{value:.05},uMossFlatThreshold:{value:.35},uMossMap:t.uMossMap,uMossRoughnessMap:t.uMossRoughnessMap,uMossNormalMap:t.uMossNormalMap,uMossAoMap:t.uMossAoMap,uMossColor:t.uMossColor,uMossTexScale:{value:2},uMossRoughness:{value:1},uMossAoStrength:{value:1},uMossBump:{value:.5},uMossBumpScale:{value:3}},c=`
...
`+c).replace("#include <map_fragment>",`#include <map_fragment>
          ...
          normal = normalize(mix(normal, mView, mossAmt));`)},x.customProgramCacheKey=()=>"moss-model-v1",x.needsUpdate=!0)}function d(x){if(!x)return;const m=new Set([l.uMossMap.value,l.uMossRoughnessMap.value,l.uMossNormalMap.value,l.uMossAoMap.value]);for(const p of Object.values(x))p&&p.isTexture&&!m.has(p)&&p.dispose();x.dispose()}function h(x){a&&(r.remove(a),a.traverse(y=>{y.geometry&&y.geometry.dispose(),Array.isArray(y.material)?y.material.forEach(d):d(y.material)})),o.clear();const m=new Xn().setFromObject(x),p=m.getCenter(new D);x.position.x-=p.x,x.position.z-=p.z,x.position.y-=m.min.y,x.traverse(y=>{y.isMesh&&(y.castShadow=!0,y.receiveShadow=!0,Array.isArray(y.material)?y.material.forEach(u):u(y.material))}),a=x,r.add(x),f()}function f(){r.updateMatrixWorld(!0),l.uModelInv.value.copy(r.matrixWorld).invert()}function g(x,m){s.load(x,p=>h(p.scene),void 0,p=>m&&m(p))}return g(n),{group:r,moss:l,importFile(x){const m=URL.createObjectURL(x);g(m,p=>console.error("Failed to load GLB:",p))},loadModel(x){g(x,m=>console.error("Failed to load GLB:",m))},refreshMatrix:f,setVisible(x){r.visible=x},get isVisible(){return r.visible}}}const Nh=document.getElementById("app"),ln=new mv({canvas:Nh,antialias:!0,powerPreference:"high-performance"});ln.setPixelRatio(Math.min(window.devicePixelRatio,2));ln.setSize(window.innerWidth,window.innerHeight);ln.shadowMap.enabled=!0;ln.shadowMap.type=Wu;ln.toneMapping=Ma;ln.toneMappingExposure=.85;const kt=new sh;kt.background=new Se(1512209);kt.fog=new kl(1512209,.006);const Kt=new qt(45,window.innerWidth/window.innerHeight,.1,500);Kt.position.set(6,20,32);const Cn=new _v(Kt,Nh);Cn.enableDamping=!0;Cn.dampingFactor=.05;Cn.maxPolarAngle=Math.PI*.495;Cn.minDistance=2;Cn.maxDistance=300;Cn.target.set(0,0,0);const Hx=new ul(ln);kt.environment=Hx.fromScene(new Pv,.04).texture;kt.environmentIntensity=.4;const Wt=new Yl(16773597,3);Wt.position.set(8,12,6);Wt.castShadow=!0;Wt.shadow.mapSize.set(2048,2048);Wt.shadow.camera.near=1;Wt.shadow.camera.far=60;Wt.shadow.camera.left=-15;Wt.shadow.camera.right=15;Wt.shadow.camera.top=15;Wt.shadow.camera.bottom=-15;Wt.shadow.bias=-2e-4;Wt.shadow.normalBias=.02;kt.add(Wt);const jl=new Yl(7113983,.5);jl.position.set(-9,5,-4);kt.add(jl);const gr=new Mh(16767392,110,50,Math.PI*.25,.4,1.2);gr.position.set(-6,8,-10);gr.target.position.set(0,0,0);kt.add(gr);kt.add(gr.target);const Gx=new np(3813156,.4);kt.add(Gx);let Uh="/Ground103_1K-JPG_";const Fh=new vh,Oh=ln.capabilities.getMaxAnisotropy();let gl=[];const Nt=new Gi({normalMapType:or,roughness:1,metalness:0,aoMapIntensity:1,normalScale:new ge(1,1),displacementScale:0,displacementBias:0,envMapIntensity:1});function Bh(){const i=(e,t=!1)=>{const n=Fh.load(Uh+e+".jpg");return t&&(n.colorSpace=Ut),n.wrapS=n.wrapT=Ai,n.anisotropy=Oh,n};for(const e of gl)e.dispose();Nt.map=i("Color",!0),Nt.aoMap=i("AmbientOcclusion"),Nt.roughnessMap=i("Roughness"),Nt.normalMap=i("NormalGL"),Nt.displacementMap=i("Displacement"),Nt.needsUpdate=!0,gl=[Nt.map,Nt.aoMap,Nt.roughnessMap,Nt.normalMap,Nt.displacementMap],Wh(Us.textureScale)}const Ta={uTime:{value:0}},We={uMoundScale:{value:.12},uSeed:{value:new ge(8.3,2.1)},uMoundDepth:{value:.55},uMoundCoverage:{value:1},uMoundEdge:{value:.15},uBumpScale:{value:.7},uBumpStrength:{value:.6},uSoilColor:{value:new Se(16777215)},uVarScale:{value:.08},uVarAmount:{value:.28},uVarCoverage:{value:1},uVarEdge:{value:.15},uVarSeed:{value:new ge(2,7)},uMoisture:{value:0},uMoistScale:{value:.18},uMoistEdge:{value:.12},uMoistSeed:{value:new ge(5,5)},uWetDarken:{value:.5},uWetRoughness:{value:.35},uCrackEnabled:{value:0},uCrackAmount:{value:.75},uCrackScale:{value:.9},uCrackWidth:{value:.06},uCrackWarp:{value:0},uCrackDepth:{value:.7},uCrackSeed:{value:new ge(11,5)},uReliefShading:{value:.7},uTime:Ta.uTime},ct={uMossEnabled:{value:0},uMossScale:{value:.14},uMossSeed:{value:new ge(4.2,6.6)},uMossCoverage:{value:.55},uMossEdge:{value:.14},uMossDepth:{value:.14},uMossBumpScale:{value:.9},uMossBumpStrength:{value:.7},uMossMap:{value:null},uMossRoughnessMap:{value:null},uMossNormalMap:{value:null},uMossAoMap:{value:null},uMossColor:{value:new Se(16777215)},uMossRoughness:{value:1},uMossTextureScale:{value:.35},uMossNormalScale:{value:1},uMossAoStrength:{value:1}};let Vu=[];function Wx(){const i=e=>{const t=Fh.load("/Moss002_1K-JPG_"+e+".jpg");return t.wrapS=t.wrapT=Ai,t.anisotropy=Oh,t};for(const e of Vu)e.dispose();ct.uMossMap.value=i("Color"),ct.uMossRoughnessMap.value=i("Roughness"),ct.uMossNormalMap.value=i("NormalGL"),ct.uMossAoMap.value=i("AmbientOcclusion"),Vu=[ct.uMossMap.value,ct.uMossRoughnessMap.value,ct.uMossNormalMap.value,ct.uMossAoMap.value]}const kh=`
...
`,Hu=kh+zh+Xx;Nt.onBeforeCompile=i=>{Object.assign(i.uniforms,We,ct),i.vertexShader=i.vertexShader.replace("#include <common>",`#include <common>
varying vec3 vWorldPosition;
`+Hu).replace("#include <begin_vertex>",`#include <begin_vertex>
...
varying vec3 vWorldPosition;
`+Hu).replace("#include <map_fragment>",`#include <map_fragment>
      ...
      normal = normalize(mix(normal, crackView, smoothstep(0.02, 0.5, cracks)));`)};Nt.customProgramCacheKey=()=>"soil-moss-v2";const _l=new Cs(20,20,256,256);_l.setAttribute("uv1",_l.attributes.uv);const Aa=new ut(_l,Nt);Aa.rotation.x=-Math.PI/2;Aa.receiveShadow=!0;Aa.castShadow=!0;kt.add(Aa);const ps={uWindDir:{value:new ge(1,.35).normalize()},uWindStrength:{value:.5},uWindSpeed:{value:1.8},uWindScale:{value:.35},uGust:{value:.6}},kn={strength:.5,speed:1.8,scale:.35,gust:.6,direction:20};function Ns(){const i=Wi.degToRad(kn.direction);ps.uWindDir.value.set(Math.cos(i),Math.sin(i)),ps.uWindStrength.value=kn.strength,ps.uWindSpeed.value=kn.speed,ps.uWindScale.value=kn.scale,ps.uGust.value=kn.gust}Ns();const Vh=20,Dt=rx({sharedUniforms:Ta,soilUniforms:We,mossUniforms:ct,windUniforms:ps,noiseGLSL:kh,heightGLSL:zh,sunLight:Wt,area:Vh});Dt.mesh.visible=!1;kt.add(Dt.mesh);const vl={"Rusty Car":"/old_rusty_car_2.glb","Porsche 911":"/porsche_911.glb"},Tt=Vx({scene:kt,sharedUniforms:Ta,mossUniforms:ct,defaultUrl:vl["Rusty Car"]}),Ue=sx({renderer:ln,scene:kt,camera:Kt});Ue.fog.uniforms.uSunDir.value.copy(Wt.position).normalize();Ue.fog.uniforms.uSunColor.value.copy(Wt.color);Ue.fog.uniforms.uHalfXZ.value=Vh/2;const Ci={autoOrbit:!0,orbitSpeed:1,fov:24,letterbox:!0};Cn.autoRotate=Ci.autoOrbit;Cn.autoRotateSpeed=Ci.orbitSpeed;Kt.fov=Ci.fov;Kt.updateProjectionMatrix();const Yx=document.getElementById("bar-top"),qx=document.getElementById("bar-bottom");function Hh(){const i=Ci.letterbox?"8vh":"0";Yx.style.height=i,qx.style.height=i}Hh();const Gh=new Ct({transparent:!0,depthWrite:!1,side:dn,uniforms:{uOpacity:{value:0},uColor:{value:new Se(16763279)}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `}),ti=new ut(new Cs(1,1),Gh);ti.frustumCulled=!1;ti.visible=!1;kt.add(ti);let ca=0;const Gu=new D;function Kx(){ca=1.2,ti.visible=!0}function $x(i){if(ca<=0){ti.visible&&(ti.visible=!1);return}ca-=i;const e=Ue.bokeh.uniforms.focus.value;Kt.getWorldDirection(Gu),ti.position.copy(Kt.position).addScaledVector(Gu,e),ti.quaternion.copy(Kt.quaternion);const t=Math.tan(Wi.degToRad(Kt.fov/2))*e,n=t*Kt.aspect;ti.scale.set(n*2*.92,t*2*.92,1),Gh.uniforms.uOpacity.value=.9*Math.min(1,ca/.4)}const Us={textureScale:2,normalIntensity:1,aoIntensity:1,roughnessIntensity:1,displacementScale:0};function Wh(i){for(const e of gl)e.repeat.set(i,i)}Bh();Wx();const li=new Zl({title:Z("guiTitle")}),Yi=li.addFolder(Z("folderMaterial")),Zx={material:"Ground103"};Yi.add(Zx,"material",["Ground048","Ground103"]).name(Z("materialBase")).onChange(i=>{Uh=`/${i}_1K-JPG_`,Bh()});Yi.add(Us,"textureScale",.5,20,.1).name(Z("textureScale")).onChange(Wh);Yi.add(Us,"normalIntensity",0,3,.01).name(Z("normalStrength")).onChange(i=>Nt.normalScale.set(i,i));Yi.add(Us,"aoIntensity",0,3,.01).name(Z("envIntensity")).onChange(i=>Nt.aoMapIntensity=i);Yi.add(Us,"roughnessIntensity",0,2,.01).name(Z("roughnessIntensity")||Z("roughness")).onChange(i=>Nt.roughness=i);Yi.add(Us,"displacementScale",0,1,.001).name(Z("displacement")).onChange(i=>Nt.displacementScale=i);Yi.close();const _r=li.addFolder(Z("folderSoil")),Rn=_r.addFolder(Z("folderMounds"));Rn.add(We.uMoundScale,"value",.02,.8,.001).name(Z("moundScale"));Rn.add(We.uSeed.value,"x",-50,50,.1).name(Z("seedX")).listen();Rn.add(We.uSeed.value,"y",-50,50,.1).name(Z("seedY")).listen();Rn.add({randomize:()=>We.uSeed.value.set((Math.random()-.5)*100,(Math.random()-.5)*100)},"randomize").name(Z("randomizeSeed"));Rn.add(We.uMoundDepth,"value",0,3,.01).name("Mound Height");Rn.add(We.uMoundCoverage,"value",0,1,.01).name(Z("coverage"));Rn.add(We.uMoundEdge,"value",.001,.4,.001).name("Coverage Softness");Rn.add(We.uBumpScale,"value",.1,3,.01).name(Z("reliefScale"));Rn.add(We.uBumpStrength,"value",0,2,.01).name(Z("reliefStrength"));Rn.add(We.uReliefShading,"value",0,1,.01).name("Relief Shading");const ci=_r.addFolder(Z("folderTone"));ci.addColor({c:"#ffffff"},"c").name("Soil Tint").onChange(i=>We.uSoilColor.value.set(i));ci.add(We.uVarAmount,"value",0,1,.01).name("Tone Variation");ci.add(We.uVarScale,"value",.01,.5,.001).name("Variation Scale");ci.add(We.uVarCoverage,"value",0,1,.01).name(Z("coverage"));ci.add(We.uVarEdge,"value",.001,.4,.001).name("Patch Softness");ci.add(We.uVarSeed.value,"x",-50,50,.1).name(Z("seedX")).listen();ci.add(We.uVarSeed.value,"y",-50,50,.1).name(Z("seedY")).listen();ci.add({randomize:()=>We.uVarSeed.value.set((Math.random()-.5)*100,(Math.random()-.5)*100)},"randomize").name(Z("randomizeSeed"));const ui=_r.addFolder(Z("folderMoisture"));ui.add(We.uMoisture,"value",0,1,.01).name(Z("coverage"));ui.add(We.uMoistEdge,"value",.001,.4,.001).name("Patch Softness");ui.add(We.uMoistScale,"value",.02,.8,.001).name("Patch Scale");ui.add(We.uMoistSeed.value,"x",-50,50,.1).name(Z("seedX")).listen();ui.add(We.uMoistSeed.value,"y",-50,50,.1).name(Z("seedY")).listen();ui.add({randomize:()=>We.uMoistSeed.value.set((Math.random()-.5)*100,(Math.random()-.5)*100)},"randomize").name(Z("randomizeSeed"));ui.add(We.uWetDarken,"value",.2,1,.01).name("Wet Darkening");ui.add(We.uWetRoughness,"value",.05,1,.01).name("Wet Gloss");const qn=_r.addFolder(Z("folderCracks")),Jx={enabled:!1};qn.add(Jx,"enabled").name(Z("enabled")).onChange(i=>We.uCrackEnabled.value=i?1:0);qn.add(We.uCrackAmount,"value",0,1,.01).name("Crack Amount");qn.add(We.uCrackScale,"value",.1,3,.01).name("Plate Density");qn.add(We.uCrackWidth,"value",.01,.25,.001).name("Channel Width");qn.add(We.uCrackWarp,"value",0,2,.01).name("Edge Meander");qn.add(We.uCrackDepth,"value",0,2,.01).name("Crack Depth");qn.add(We.uCrackSeed.value,"x",-50,50,.1).name(Z("seedX")).listen();qn.add(We.uCrackSeed.value,"y",-50,50,.1).name(Z("seedY")).listen();qn.add({randomize:()=>We.uCrackSeed.value.set((Math.random()-.5)*100,(Math.random()-.5)*100)},"randomize").name(Z("randomizeSeed"));Rn.close();ci.close();ui.close();qn.close();_r.close();const vr=li.addFolder(Z("folderMoss")),jx={enabled:!1};vr.add(jx,"enabled").name(Z("mossEnabled")).onChange(i=>ct.uMossEnabled.value=i?1:0);const qi=vr.addFolder(Z("folderMossMask"));qi.add(ct.uMossCoverage,"value",0,1,.01).name(Z("mossCoverage"));qi.add(ct.uMossScale,"value",.02,.8,.001).name(Z("mossMaskScale"));qi.add(ct.uMossEdge,"value",.001,.4,.001).name(Z("mossEdge"));qi.add(ct.uMossSeed.value,"x",-50,50,.1).name(Z("seedX")).listen();qi.add(ct.uMossSeed.value,"y",-50,50,.1).name(Z("seedY")).listen();qi.add({randomize:()=>ct.uMossSeed.value.set((Math.random()-.5)*100,(Math.random()-.5)*100)},"randomize").name(Z("randomizeSeed"));qi.close();const wa=vr.addFolder(Z("folderMossVol"));wa.add(ct.uMossDepth,"value",0,1,.005).name("Thickness");wa.add(ct.uMossBumpScale,"value",.1,3,.01).name("Relief Scale");wa.add(ct.uMossBumpStrength,"value",0,2,.01).name("Relief Strength");wa.close();const Fs=vr.addFolder(Z("folderMossLook"));Fs.add(ct.uMossTextureScale,"value",.05,2,.005).name("Texture Scale");Fs.addColor({c:"#ffffff"},"c").name("Moss Tint").onChange(i=>ct.uMossColor.value.set(i));Fs.add(ct.uMossRoughness,"value",0,2,.01).name(Z("roughness"));Fs.add(ct.uMossNormalScale,"value",0,3,.01).name("Normal Intensity");Fs.add(ct.uMossAoStrength,"value",0,2,.01).name("AO Intensity");Fs.close();vr.close();const Kn=li.addFolder(Z("folderModel")),Qx={showModel:!1};Kn.add(Qx,"showModel").name(Z("modelLoad")).onChange(i=>Tt.setVisible(i));const eM={active:"Rusty Car"};Kn.add(eM,"active",Object.keys(vl)).name(Z("modelPick")).onChange(i=>Tt.loadModel(vl[i]));const xl=document.getElementById("glb-input");xl.addEventListener("change",i=>{const e=i.target.files[0];e&&Tt.importFile(e),xl.value=""});Kn.add({import:()=>xl.click()},"import").name("📂 Import GLB…");const zn={scale:1,posX:0,posY:0,posZ:0,rotY:0};function xr(){Tt.group.scale.setScalar(zn.scale),Tt.group.position.set(zn.posX,zn.posY,zn.posZ),Tt.group.rotation.y=Wi.degToRad(zn.rotY),Tt.refreshMatrix()}Kn.add(zn,"scale",.05,10,.01).name("Scale").onChange(xr);Kn.add(zn,"posX",-10,10,.01).name("Position X").onChange(xr);Kn.add(zn,"posY",-5,10,.01).name("Position Y").onChange(xr);Kn.add(zn,"posZ",-10,10,.01).name("Position Z").onChange(xr);Kn.add(zn,"rotY",0,360,1).name("Rotation Y°").onChange(xr);const tn=Kn.addFolder(Z("folderAccum"));tn.add(Tt.moss.uMossCoverage,"value",0,1,.01).name(Z("accumCoverage"));tn.add(Tt.moss.uMossThickness,"value",0,.3,.001).name("Thickness");tn.add(Tt.moss.uMossScale,"value",.1,4,.01).name(Z("accumScale"));tn.add(Tt.moss.uMossEdge,"value",.01,.4,.005).name("Patch Softness");tn.add(Tt.moss.uMossSeed.value,"x",-50,50,.1).name(Z("accumSeedX")).listen();tn.add(Tt.moss.uMossSeed.value,"y",-50,50,.1).name(Z("accumSeedY")).listen();tn.add({randomize:()=>Tt.moss.uMossSeed.value.set((Math.random()-.5)*100,(Math.random()-.5)*100)},"randomize").name(Z("accumRandomize"));tn.add(Tt.moss.uMossFlatThreshold,"value",0,1,.01).name("Flatness Cutoff");tn.add(Tt.moss.uMossTexScale,"value",.2,8,.05).name("Texture Scale");tn.add(Tt.moss.uMossRoughness,"value",0,2,.01).name(Z("roughness"));tn.add(Tt.moss.uMossAoStrength,"value",0,2,.01).name("AO Intensity");tn.add(Tt.moss.uMossBump,"value",0,1.5,.01).name("Relief Strength");tn.add(Tt.moss.uMossBumpScale,"value",.5,8,.05).name("Relief Scale");tn.close();Kn.close();const Xh={enabled:!1,density:.13},mn=li.addFolder(Z("folderGrass"));mn.add(Xh,"enabled").name(Z("grassEnabled")).onChange(i=>Dt.mesh.visible=i);mn.add(Xh,"density",0,1,.01).name(Z("grassCount")).onChange(i=>Dt.setDensity(i));const Ki=mn.addFolder(Z("folderGrassMask"));Ki.add(Dt.uniforms.uCoverage,"value",0,1,.01).name(Z("grassCoverage"));Ki.add(Dt.uniforms.uMaskScale,"value",.02,.8,.001).name(Z("grassMaskScale"));Ki.add(Dt.uniforms.uMaskEdge,"value",.001,.4,.001).name(Z("grassEdge"));Ki.add(Dt.uniforms.uMaskSeed.value,"x",-50,50,.1).name(Z("seedX")).listen();Ki.add(Dt.uniforms.uMaskSeed.value,"y",-50,50,.1).name(Z("seedY")).listen();Ki.add({randomize:()=>Dt.uniforms.uMaskSeed.value.set((Math.random()-.5)*100,(Math.random()-.5)*100)},"randomize").name(Z("randomizeSeed"));Ki.close();mn.add(Dt.uniforms.uHeight,"value",.2,2.5,.01).name("Blade Height");mn.add(Dt.uniforms.uWidth,"value",.02,.25,.001).name("Blade Width");mn.add(Dt.uniforms.uCurl,"value",0,2.2,.01).name("Curl");mn.addColor({c:"#33421b"},"c").name("Base Color").onChange(i=>Dt.uniforms.uColorBase.value.set(i));mn.addColor({c:"#9bc24a"},"c").name("Tip Color").onChange(i=>Dt.uniforms.uColorTip.value.set(i));mn.add(Dt.uniforms.uColorVarAmt,"value",0,.6,.01).name("Color Variation");mn.add(Dt.uniforms.uTranslucency,"value",0,2,.01).name("Translucency");mn.add(Dt.material,"roughness",0,1,.01).name(Z("roughness"));mn.close();const Os=li.addFolder(Z("folderWind"));Os.add(kn,"strength",0,2,.01).name(Z("windStrength")).onChange(Ns);Os.add(kn,"speed",0,6,.01).name(Z("windSpeed")).onChange(Ns);Os.add(kn,"direction",0,360,1).name(Z("windDir")).onChange(Ns);Os.add(kn,"scale",.05,1.5,.01).name(Z("windGust")).onChange(Ns);Os.add(kn,"gust",0,1.5,.01).name(Z("windFlutter")).onChange(Ns);Os.close();const Ri=li.addFolder(Z("folderLighting"));Ri.add(ln,"toneMappingExposure",0,3,.01).name(Z("exposure"));Ri.add(Wt,"intensity",0,8,.01).name(Z("keyLight"));Ri.add(jl,"intensity",0,4,.01).name(Z("fillLight"));Ri.add(gr,"intensity",0,400,1).name(Z("rimLight"));Ri.add(kt,"environmentIntensity",0,2,.01).name(Z("envIntensity"));const va={enabled:!0,density:kt.fog.density};function Yh(){kt.fog.density=va.enabled?va.density:0}Ri.add(va,"enabled").name("Atmos Fog").onChange(Yh);Ri.add(va,"density",0,.03,5e-4).name("Atmos Density").onChange(Yh);Ri.close();const qh={enabled:!1,driftDir:17},Bs=li.addFolder(Z("folderClouds"));Bs.add(qh,"enabled").name(Z("cloudsEnabled")).onChange(i=>Ue.fog.setEnabled(i));const Pn=Bs.addFolder(Z("folderCShape"));Pn.add(Ue.fog.uniforms.uBase,"value",-3,20,.05).name("Layer Height");Pn.add(Ue.fog.uniforms.uHeight,"value",.2,12,.1).name(Z("cloudThickness"));Pn.add(Ue.fog.uniforms.uHeightFalloff,"value",0,1,.01).name("Ground Hug");Pn.add(Ue.fog.uniforms.uDensity,"value",0,8,.02).name(Z("cloudDensity"));Pn.add(Ue.fog.uniforms.uCoverage,"value",0,1,.01).name(Z("cloudCoverage"));Pn.add(Ue.fog.uniforms.uCoverageEdge,"value",.01,.5,.005).name("Billow Softness");Pn.add(Ue.fog.uniforms.uNoiseScale,"value",.02,.6,.005).name("Billow Scale");Pn.add(Ue.fog.uniforms.uDetail,"value",0,1,.01).name("Detail");Pn.add(Ue.fog.uniforms.uDetailScale,"value",1,12,.1).name("Detail Scale");Pn.add(Ue.fog.uniforms.uEdgeFade,"value",0,6,.1).name("Edge Fade");const Ql=Bs.addFolder(Z("folderCMove"));Ql.add(Ue.fog.uniforms.uWindSpeed,"value",0,1,.005).name(Z("cloudSpeed"));Ql.add(qh,"driftDir",0,360,1).name("Drift Direction °").onChange(i=>{const e=Wi.degToRad(i);Ue.fog.uniforms.uWindDir.value.set(Math.cos(e),Math.sin(e))});const ks=Bs.addFolder(Z("folderCLight"));ks.add(Ue.fog.uniforms.uSunStrength,"value",0,6,.02).name(Z("cloudSun"));ks.add(Ue.fog.uniforms.uAniso,"value",0,.95,.01).name("Backlight (HG)");ks.add(Ue.fog.uniforms.uAmbient,"value",0,1,.01).name(Z("cloudAmbient"));ks.addColor({c:"#cdd6dd"},"c").name("Body Color").onChange(i=>Ue.fog.uniforms.uFogColor.value.set(i));ks.addColor({c:"#ffe9c8"},"c").name("Scatter Color").onChange(i=>Ue.fog.uniforms.uSunColor.value.set(i));const Mr=Bs.addFolder(Z("folderCQuality")),tM={scale:.5};Mr.add(tM,"scale",{Full:1,Half:.5,Quarter:.25}).name("Resolution").onChange(i=>Ue.fog.setScale(Number(i)));Mr.add(Ue.fog.uniforms.uSteps,"value",8,96,1).name(Z("cloudSteps"));Mr.add(Ue.fog.uniforms.uLightSteps,"value",0,8,1).name("Light Steps");Mr.add(Ue.fog.uniforms.uLightStepSize,"value",.1,2,.05).name("Light Step Size");Pn.close();Ql.close();ks.close();Mr.close();Bs.close();const Sr=li.addFolder(Z("folderCine")),nM={msaa:Math.min(4,Ue.maxSamples)},iM={Off:0,"2×":2,"4×":4,"8×":8};Sr.add(nM,"msaa",iM).name("Anti-aliasing").onChange(i=>Ue.setSamples(Number(i)));const Ca=Sr.addFolder(Z("folderCam"));Ca.add(Ci,"autoOrbit").name(Z("autoOrbit")).onChange(i=>Cn.autoRotate=i);Ca.add(Ci,"orbitSpeed",-3,3,.05).name(Z("orbitSpeed")).onChange(i=>Cn.autoRotateSpeed=i);Ca.add(Ci,"fov",18,80,1).name(Z("fov")).onChange(i=>{Kt.fov=i,Kt.updateProjectionMatrix()});Ca.add(Ci,"letterbox").name(Z("letterbox")).onChange(Hh);const Kh={enabled:!1};Ue.bokeh.enabled=Kh.enabled;const Ra=Sr.addFolder(Z("folderDof"));Ra.add(Kh,"enabled").name(Z("dofEnabled")).onChange(i=>Ue.bokeh.enabled=i);Ra.add(Ue.bokeh.uniforms.focus,"value",1,40,.1).name(Z("focusDistance")).onChange(Kx);Ra.add(Ue.bokeh.uniforms.aperture,"value",0,.004,5e-5).name(Z("aperture"));Ra.add(Ue.bokeh.uniforms.maxblur,"value",0,.02,5e-4).name(Z("maxBlur"));const Pi=Sr.addFolder(Z("folderFx"));Pi.add(Ue.bloom,"strength",0,2,.01).name(Z("bloom"));Pi.add(Ue.bloom,"radius",0,2,.01).name(Z("bloomRadius"));Pi.add(Ue.bloom,"threshold",0,1,.01).name(Z("bloomThreshold"));Pi.add(Ue.grade.uniforms.uGrain,"value",0,.25,.005).name(Z("filmGrain"));Pi.add(Ue.grade.uniforms.uVignette,"value",0,1.5,.01).name(Z("vignette"));Pi.add(Ue.grade.uniforms.uChroma,"value",0,.01,1e-4).name(Z("chromaticAberration"));Pi.add(Ue.grade.uniforms.uContrast,"value",.7,1.6,.01).name(Z("contrast"));Pi.add(Ue.grade.uniforms.uSaturation,"value",0,2,.01).name(Z("saturation"));Sr.close();window.addEventListener("resize",()=>{Kt.aspect=window.innerWidth/window.innerHeight,Kt.updateProjectionMatrix(),ln.setSize(window.innerWidth,window.innerHeight),ln.setPixelRatio(Math.min(window.devicePixelRatio,2)),Ue.setSize(window.innerWidth,window.innerHeight)});const sM=new vp;ln.setAnimationLoop(()=>{const i=Math.min(sM.getDelta(),.1);Ta.uTime.value+=i,Cn.update(),Dt.update(Kt.position),$x(i),Ue.render(i)});
